...
The **Storefront API reference** is a subset of [Admin API](../api-reference) representing public entities ie. that no permissions are required to perform operations on them.
...
You can try out our API at [Saleor Storefront Example](https://storefront1.saleor.io/graphql/).
