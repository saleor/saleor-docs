...
If you use the API to modify objects (for example, with an external app), please note that channel-depending fields have dedicated mutations. Updating product price requires using the [productChannelListingUpdate](api-reference/mutations/product-channel-listing-update.mdx) mutation.

Object attributes that can be defined on a channel basis can be referenced.

- [Collection Channel Listing](api-reference/objects/collection-channel-listing.mdx)
- [Product Channel Listing](api-reference/objects/product-channel-listing.mdx)
- [ProductVariant Channel Listing](api-reference/objects/product-variant-channel-listing.mdx)
- [Sale Channel Listing](api-reference/objects/sale-channel-listing.mdx)
- [ShippingMethod Channel Listing](api-reference/objects/shipping-method-channel-listing.mdx)
- [Voucher Channel Listing](api-reference/objects/voucher-channel-listing.mdx)
...
If you want to create access tokens, you can do that by creating an [App](developer/extending/apps/index.mdx).
