...
| Sendgrid        | `mirumee.notifications.sendgrid_email` | [Saleor SMTP App](../../developer/app-store/apps/smtp/overview.mdx). On Saleor Cloud 3.23+, [Customer Emails](../../developer/app-store/apps/customer-emails/overview.mdx) replaces it for new stores. |
