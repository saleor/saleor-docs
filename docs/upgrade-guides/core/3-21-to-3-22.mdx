...
The legacy behavior is now deprecated as of version 3.22.
...
Disabling this setting prevents sending update webhooks when no changes are made to the instance, reducing unnecessary webhook traffic.

### Applicable Mutations

This setting currently applies to the following mutations:
