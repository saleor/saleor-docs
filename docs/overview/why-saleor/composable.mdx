...
For example, you might want to combine independent vendors of `Content management`, `Checkout API`, and `Order management` that suits your business needs, commonly referred to as _best-of-breed_ architecture.
