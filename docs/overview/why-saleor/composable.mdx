...
For instance, you may choose to integrate independent vendors for _Content Management_,
_Checkout API_, and _Order Management_ that align with your unique business requirements.
Such composition of the system is commonly referred to as a best-of-breed architecture.
