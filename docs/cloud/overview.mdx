...
It operates as a **SaaS**, where Saleor handles infrastructure, performance, updates, and security so you can focus on building your storefront.
...
Once you're ready to bring your ecommerce POC to life, take a free [1:1 dev support session](https://www.getclockwise.com/c/rian-dillon-saleor-io/saleor-cloud) with our Solutions Engineer.

Access to cloud can be configured via SSO.

## Cloud Console

The Cloud Console is your central hub for managing all things Saleor Cloud. 
