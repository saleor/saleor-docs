...
description: Learn about Saleor Cloud, including account creation, organizations, projects, and environments.
---
...
take a free [1:1 dev support session](https://saleor.io/cloud/talk-to-us?cta=1%3A1%20dev%20support%20session&cta_page=docs%2Fcloud) with our Solutions Engineer.
:::
...
Projects represent the core unit of organization within Saleor. 
...
#### Project Types
- **Production Project:** Contain one Production Environment (your live store) and the number of Sandbox Environments specified in your plan. 
Snapshots and backups can be created in Production and restored into Sandboxes for testing and staging.
- **Developer Projects:** Contain only Sandbox Environments and are intended for development and testing. 
They cannot be used as live stores, but can be upgraded to Production at any time.
...
Learn more about [environments](/cloud/environment.mdx).

## Cloud Lifecycle 

Saleor Cloud manages resources automatically to keep environments clean and efficient.
Inactive developer projects, sandboxes, organizations, or accounts may be flagged for suspension and eventually deleted if unused for extended periods.

Saleor will always notify account holders before removing resources, giving you the opportunity to reactivate.

For full details about suspension and deletion timelines, please refer to our 
[Terms of Service](https://saleor.io/legal/terms) - Section 3.3. Developer Projects.
