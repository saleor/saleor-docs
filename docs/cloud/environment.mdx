...
Subdomains of your environments (for example, `[your_subdomain].saleor.cloud`) can be changed on demand in the console.
...
- You can enable/disable maintenance mode from the environment page in the console.
