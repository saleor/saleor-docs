...
If your environment has been automatically deleted due to inactivity, you can restore it from a snapshot within 7 days. You don't need to contact support to restore your environment - you can do it yourself by following these steps:

1. Go to the cloud project and click `New Sandbox`
2. Fill the form you can set the same sandbox domain as before
3. In the database scetion select `Use snapshot` option
