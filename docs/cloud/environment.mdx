...
| **Rate limits – Free plan** | 120 requests/min                                                                     | -                                                           |
| **Rate limits – Paid plan** | 2,000 requests/min                                                                   | No enforced request limit                                      |
| **Upgrades**                | **Free plan sandboxes** auto-upgrade to the latest minor version<br/> **Paid plan sandboxes and prod** must be upgraded manually | Same as sandbox on paid plans. Enterprise upgrades coordinated with Saleor team |
| **Snapshots / Backups**     | On demand, triggered by cloud users.                                                 | Automatic daily snapshots                                      |
| **Support & SLA**           | No SLA, limited support                                                              | SLA-backed support (depending on plan)                         |
| **“Go Live” action**        | Promotes sandbox → production. Downtime expected (~5 minutes during database restore)|                                                                |
| **Selling products**        | **Not allowed under ToS** – sandbox is for testing only                              | Fully supported for commerce                                   |
