...
- Patch Release: `3.21.0 → 3.21.1` - Bug fixes and security updates, no new features. 
- Minor Release: `3.20 → 3.21` - Backward-compatible improvements and new features. 
- Major Release: `3.x → 4.0` - May include breaking changes and require migration work. 
