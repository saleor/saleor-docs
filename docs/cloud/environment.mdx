...
Trusted client origins are the allowed domains used in sensitive user flows such as account registration, password reset, and email confirmations.

- Values must be full URLs, including the scheme, domain, and optional port.
