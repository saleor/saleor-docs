---
title: Restricting API Access in Saleor Environments
sidebar_position: 2
description: Learn how to restrict API access in Saleor Cloud using allowed origins and password protection.
---

Even though Saleor [implements complex authorization and authentication](/api-usage/authentication.mdx) mechanisms, you might want to restrict access to your Saleor Environment for specific use cases.
