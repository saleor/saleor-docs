...
- [`tokenRefresh`](/api-reference/authentication/mutations/token-refresh.mdx) — in `CUSTOMERS_ONLY`, refreshing a token continues to return a token without staff permissions
