...
To prevent abuse of the password reset functionality, Saleor uses password reset throttling. You can only request single password reset link per IP address per 15 minutes.
