...
<S>
    ...
    <S.Step>
        <S.Details>
            ### Add backend URL
            Use a [free developer account](quickstart/cloud.mdx#signup) at Saleor Cloud to start quickly with the backend.
        ...
        <S.Code>
            ...
            # Local example
            # NEXT_PUBLIC_SALEOR_API_URL=http://localhost:9000/graphql/
            ```
        </S.Code>
    </S.Step>
