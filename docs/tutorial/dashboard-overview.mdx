...
TODO: This should be the entry point for dashboard-related tutorials, namely [learn.saleor.io](https://learn.saleor.io).

## About the dashboard

The Saleor dashboard is the administration panel behind your storefront. In a nutshell, it is for managing people, products, and processes:
