...
<Block title="Recipes" >
    <Chapters>
        [<Tag size={16} strokeWidth={1.5}/> **Multi-region** _Build global experience with regions, currencies, and storefronts._](/recipes/multi-region.mdx)

        [<ShoppingBag size={16} strokeWidth={1.5}/> **Digital Products** _Sell licenses, services, and other non-physical goods._](/recipes/digital-products.mdx)

        [<Split size={16} strokeWidth={1.5}/> **Click and collect** _Managing in-store order pickup._](/recipes/click-and-collect.mdx)

        [<TableProperties size={16} strokeWidth={1.5}/> **Extending dashboard** _Add new management views to the Dashboard._](/recipes/extending-dashboard.mdx)

        [<TableProperties size={16} strokeWidth={1.5}/> **Custom shipping** _Shipping options tailored to your customers._](/recipes/custom-shipping.mdx)
