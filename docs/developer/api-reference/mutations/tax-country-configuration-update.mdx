...
#### [<code style={{ fontWeight: 'normal' }}>taxCountryConfigurationUpdate.<b>countryCode</b></code>](#)<Bullet />[`CountryCode!`](../../../developer/api-reference/enums/country-code) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="enum"/>

> Country in which to update the tax class rates.

#### [<code style={{ fontWeight: 'normal' }}>taxCountryConfigurationUpdate.<b>updateTaxClassRates</b></code>](#)<Bullet />[`[TaxClassRateInput!]!`](../../../developer/api-reference/inputs/tax-class-rate-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
