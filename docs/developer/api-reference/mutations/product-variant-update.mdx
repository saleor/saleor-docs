...
#### `input` ([`ProductVariantInput!`](/docs/developer/api-reference/inputs/product-variant-input))

Fields required to update a product variant.

### Type

#### [`ProductVariantUpdate`](/docs/developer/api-reference/objects/product-variant-update)
