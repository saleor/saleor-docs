...
#### `input` ([`ProductImageCreateInput!`](/developer/api-reference/inputs/product-image-create-input.mdx))

Fields required to create a product image.

### Type

#### [`ProductImageCreate`](/developer/api-reference/objects/product-image-create.mdx)
