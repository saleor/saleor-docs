...
#### `input` ([`ExternalNotificationTriggerInput!`](/docs/developer/api-reference/inputs/external-notification-trigger-input))
...
#### [`ExternalNotificationTrigger`](/docs/developer/api-reference/objects/external-notification-trigger)
