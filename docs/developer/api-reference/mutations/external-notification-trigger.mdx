...
#### `input` ([`ExternalNotificationTriggerInput!`](/developer/api-reference/inputs/external-notification-trigger-input.mdx))
...
#### [`ExternalNotificationTrigger`](/developer/api-reference/objects/external-notification-trigger.mdx)
