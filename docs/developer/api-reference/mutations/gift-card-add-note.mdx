...
#### `input` ([`GiftCardAddNoteInput!`](/docs/developer/api-reference/inputs/gift-card-add-note-input))

Fields required to create a note for the gift card.

### Type

#### [`GiftCardAddNote`](/docs/developer/api-reference/objects/gift-card-add-note)
