...
You can read more about the app permissions in the [App permissions](developer/extending/apps/architecture/app-permissions.mdx) article.
...
| MANAGE_ORDERS_IMPORT                | Manage order imports                |
