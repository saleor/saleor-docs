...
Instead of assigning permissions directly to the user, we define them on a group basis. Organizing access rights in [Groups](docs/api-reference/users/objects/group.mdx) helps in determining the roles of team members.
