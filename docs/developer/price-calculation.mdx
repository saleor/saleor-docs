...
For patterns and strategies for implementing custom pricing in your store—including segment pricing, contract pricing, and dynamic pricing—see the [Custom Pricing Recipe](/recipes/custom-pricing).
