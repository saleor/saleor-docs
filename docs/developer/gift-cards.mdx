...
Firstly, you have to create a product type with `GIFT_CARD` kind (use [productTypeCreate](docs/api-reference/products/mutations/product-type-create.mdx) for that), and then create a product (use [productCreate](docs/api-reference/products/mutations/product-create.mdx) mutation)
