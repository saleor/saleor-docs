...
For bulk activation, use [giftCardBulkActivate](api-reference/mutations/gift-card-bulk-activate.mdx)
and for bulk deactivation use [giftCardBulkDeactivate](api-reference/mutations/gift-card-bulk-deactivate.mdx) mutation.

## Creating gift card products

Allowing customers to buy gift cards in your shop is pretty simple, you need to create gift card products.
Firstly, you have to create a product type with `GIFT_CARD` kind (use [productTypeCreate](api-reference/mutations/product-type-create.mdx) for that), and then create a product (use [productCreate](api-reference/mutations/product-create.mdx) mutation)
...
The value of this option can be changed with use of [orderSettingsUpdate](api-reference/mutations/order-settings-update.mdx) mutation.
...
The gift card settings are set as never expiry by default and can be changed with use of [giftCardSettingsUpdate](api-reference/mutations/gift-card-settings-update.mdx).
...
To use a gift card in the checkout just run [checkoutAddPromoCode](api-reference/mutations/checkout-add-promo-code.mdx)
