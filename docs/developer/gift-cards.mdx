...
## Creating gift cards by staff

The staff user with `MANAGE_GIFT_CARD` permission can create a single gift card
or a bunch of gift cards at once.

The following example shows how the single gift card can be created.
