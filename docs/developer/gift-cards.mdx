...
To allow customers to purchase gift cards, you have to [create a product type](api-reference/mutations/product-type-create.mdx) with `GIFT_CARD` kind and use it to [create a product](api-reference/mutations/product-create.mdx).
