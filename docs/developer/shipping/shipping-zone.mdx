...
3. Fill in the following details: - Name: A descriptive label for the zone. - Countries: Select the countries to include in this zone.
   :::note
...
```json
{
  "input": {
    ...
    "default": false,
    "addWarehouses": [
      "V2FyZWhvdXNlOjc1MjYwYWRjLTJjZjAtNGQ0ZC1hOTM5LTBmZGY2Y2FlYjBjMQ=="
    ],
    "addChannels": [
      "Q2hhbm5lbDox"
    ]
