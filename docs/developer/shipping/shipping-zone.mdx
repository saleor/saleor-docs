...
mutation {
  shippingZoneUpdate(
    ...
    input: {
      addWarehouses: [
        "V2FyZWhvdXNlOjNiN2FlMmVhLWEzMDQtNGFiZS1hY2QzLWVlZWU3ZDIxNmMyYw=="
      ]
    }
  ) {
    shippingZone {
...
- **SHIPPING_ZONE_UPDATED**: Triggered when a shipping zone is modified, including changes to countries, channels, warehouses, or general metadata. Helps ensure synchronization with external shipping services.
