...
:::note
Proxy URL will be constructed using a domain that Saleor is set to run on. This is controlled by the [`PUBLIC_URL`](/setup/configuration.mdx#public_url) environment variable.
:::
