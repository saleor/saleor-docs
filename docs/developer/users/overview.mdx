...
Staff permissions control what actions users can perform and what data they can access. Permissions are assigned through groups, making it easy to manage roles for multiple users at once. For details, see the [Permissions](/developer/permissions.mdx) guide.
