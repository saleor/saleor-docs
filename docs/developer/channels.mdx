...
- [Collection](api-reference/objects/collection-channel-listing.mdx)
- [Product](api-reference/objects/product-channel-listing.mdx)
- [ProductVariant](api-reference/objects/product-variant-channel-listing.mdx)
- [Sale](api-reference/objects/sale-channel-listing.mdx)
- [ShippingMethod](api-reference/objects/shipping-method-channel-listing.mdx)
- [Voucher](api-reference/objects/voucher-channel-listing.mdx)

## Permissions

Listing channels is allowed only for users with the active [`isStaff`](api-reference/objects/user.mdx#isstaff-boolean) flag.
...
Use [`channel`](api-reference/queries/channel.mdx) query to get channel details.
...
You can create a new channel using [`channelCreate`](api-reference/mutations/channel-create.mdx) mutation.
...
Because some of the channels may be considered non-public (for example - a channel for business partners), non-staff users cannot use the [`channels`](api-reference/queries/channels.mdx) query.
...
If you want to make the channel unavailable for customers, you can change it's status to `deactivated` using [`channelDeactivate`](api-reference/mutations/channel-deactivate.mdx) mutation:
...
And to reverse the previous operation use the [`channelActivate`](api-reference/mutations/channel-activate.mdx) mutation:
...
[`channelDelete`](api-reference/mutations/channel-delete.mdx) mutation takes [input](api-reference/inputs/channel-delete-input.mdx):
...
[`ChannelErrorCode`](api-reference/enums/channel-error-code.mdx) values:
