...
- `search: String`: search by name or part of the description using built-in full-text search. For advanced capabilities, use the [Saleor Search App](/developer/app-store/apps/search).
