...
| [Category](/developer/products/overview.mdx#collections-and-categories) | Organizes products into a hierarchical tree structure, often used for navigation in the storefront (e.g., "Clothing > Men > Shirts"). | [`categoryCreate`](/api-reference/products/mutations/category-create) |
| [Collection (Optional)](/developer/products/overview.mdx#collections-and-categories) | Groups products for marketing purposes or curated storefront sections (e.g., “Summer Sale” or “Best Sellers”). | [`collectionCreate`](/api-reference/products/mutations/collection-create) |
