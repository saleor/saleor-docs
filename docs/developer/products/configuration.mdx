...
**Variant attributes** – `Dropdown attribute` can be configured as a variant selection, meaning the attribute will be mapped to a variant. Follow the [example steps](#example-steps) to see how to configure a variant selection attribute.
