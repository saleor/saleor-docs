...
### Category
Create category in _Products_ -> _Categories_ named _T-shirts_.
...
Categories provide a hierarchical structure for organizing products. When configuring categories, you can:
...
Collections are flexible, flat groups for curating products outside the main category tree. When configuring collections, you can:
