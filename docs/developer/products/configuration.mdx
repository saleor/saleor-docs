...
To create catgory go to **Catalog** -> **Categories** or use API mutation [`categoryCreate`](/api-reference/products/mutations/category-create).
...
To create collection go to **Catalog** -> **Collections** or use API mutation [`collectionCreate`](/api-reference/products/mutations/collection-create).
...
**Stock** – Stock is set per warehouse and has limited public visibility. Learn more about [stock tracking](/developer/stock/stock-allocation.mdx).
:::warning
...
**Track inventory** – Disable automated stock tracking, [see more](/developer/stock/stock-allocation.mdx). When disabled, the stock needs to be updated via API.
