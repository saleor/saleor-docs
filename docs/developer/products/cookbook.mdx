...
For architectural patterns and guidance on choosing the right custom pricing approach for your use case, see the [Custom Pricing Recipe](/recipes/custom-pricing). For a working example implementation, refer to the [Custom prices with next.js](https://github.com/saleor/saleor-app-checkout-prices) repository.
...
In a more advanced workflow, you can use embeddings to find semantically similar products. See:

[📺 Product Recommendations with OpenAI and Saleor](/demos/similar-products.mdx)
