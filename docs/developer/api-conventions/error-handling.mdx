...
For representing code values, we are using enums. All possible values for the query above can be found on [AccountError](developer/api-reference/enums/account-error-code.mdx) reference page.
