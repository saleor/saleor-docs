...
## Creating own error clases

If you are extending Saleor by your own, you can find more information in [Extending](developer/extending/api/errors.mdx) section.
