...
:::note
Only [catalogue promotions](developer/discounts/promotions) will result in changes to Product/Variant pricing. 
...
[`productVariantChannelListingUpdate`](../../api-reference/discounts/mutations/product-variant-channel-listing-update) or 
[`productVariantBulkUpdate`](../../api-reference/discounts/mutations/product-variant-bulk-update) mutations. 

After providing `pricePrior` information to `ProductVariantChannelListing`, it will be propagated to pricing information for 
