...
These discounts cannot be combined with other discounts and override any existing ones.
The discount can be applied to the order to decrease its subtotal and shipping price, or to the order line to reduce its unit price.
...
It impacts both the subtotal and shipping price. When the order qualifies for an order promotion or has an entire order voucher applied, 
