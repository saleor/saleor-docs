...
The voucher campaign supports 10 redemptions total, each tied to a unique code. Once a code is used, it's deactivated. After 10 different codes are used, the voucher becomes inactive.
