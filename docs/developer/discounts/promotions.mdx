...
- **Base prices:** Prices after applying [`line-level discounts`](developer/discounts/overview.mdx#level).
...
Base prices are the prices after applying [`line-level discounts`](developer/discounts/overview.mdx#level). 
To learn more, please check [`Price Calculation`](developer/price-calculation.mdx#discount-application) section.
