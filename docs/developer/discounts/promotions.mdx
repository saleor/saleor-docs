...
- possible gift reward when the total price is above **$50**
...
## Catalogue and order promotions with subtotal discount
...
## Catalogue and order promotions with gift reward
