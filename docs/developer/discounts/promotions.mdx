...
The best promotion rule for this checkout is giving a **10%** discount on the subtotal price.
...
graph TD
    ...
    B --> C[Choose the promotion rule that gives the best saving for the user]
