...
graph TD
    ...
    B --> C[For gift promotion rules chose the available product variant from the assigned gifts, with the highest discounted price]
    ...
    F --> G{Choosen promotion rule is a gift promotion?}
