...
- [Recalculate price for catalog promotions](developer/discounts/catalog-promotions.mdx): every 30 seconds
...
- [Automatic checkout completion](/developer/payments/transactions#automatic-checkout-completion): every 1 minute
...
- [Promotion toggle](developer/discounts/promotions-overview.mdx): based on promotion's start date and end date
