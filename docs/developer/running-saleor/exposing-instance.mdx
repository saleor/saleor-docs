...
To achieve that, you need a service for redirecting the traffic. Such service delivers [ngrok](https://ngrok.com) and [localtunnel](https://localtunnel.me). Both are great for our use case, and you can choose any of those services.
