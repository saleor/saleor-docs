...
The [Saleor platform](https://github.com/saleor/saleor-platform) uses [Mailhog](https://github.com/mailhog/MailHog) to catch all the emails sent by the Saleor.

![Mailhog user interface](./mailhog.png)
