...
Sets upper limit on how many entities may be requested by Apollo Federation's gateway for single GraphQL Query. Defaults to `300`. Set to `0` to remove this limit.
