...
Controls the time which defines how long the JWT refresh token will be valid. The value should be provided in seconds. Default to 30 days.

### `JWT_SECRET`

Controls the key used to encode/decode JWT token.
