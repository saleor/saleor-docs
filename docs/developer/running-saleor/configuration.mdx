...
Controls the time which defines how long the JWT authentication token will be valid.The value should be a time expressions like `5m`, `5 minutes`, `5d`, `5 days`, `1w`, `1 week`. Defaults to `5 minutes`.

### `JWT_TTL_REFRESH`

Controls the time which defines how long the JWT refresh token will be valid. The value should be a time expressions like `5m`, `5 minutes`, `5d`, `5 days`, `1w`, `1 week`. Defaults to `30 days`.

### `JWT_TTL_REQUEST_EMAIL_CHANGE`

Controls the time which defines how long the token for changing an email will be valid. The value should be a time expressions like `5m`, `5 minutes`, `5d`, `5 days`, `1w`, `1 week`. Defaults to `1 hour`.
