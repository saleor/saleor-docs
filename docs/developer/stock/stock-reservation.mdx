...
is disabled, reservations are made from all warehouses assigned to the channel, regardless of the 
customer's country or shipping zone configuration. See [Stock availability mode](/developer/stock/overview.mdx#stock-availability-mode) for details.
:::
