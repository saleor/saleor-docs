...
[`productVariant.trackInventory`](/api-reference/products/objects/product-variant.mdx#track-inventory) field.
...
[`trackInventoryByDefault`](/api-reference/miscellaneous/objects/shop.mdx#track-inventory-by-default) 
