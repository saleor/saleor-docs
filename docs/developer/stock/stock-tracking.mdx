...
[`productVariant.trackInventory`](/api-reference/products/objects/product-variant.mdx#trackinventoryboolean) field.
...
[`trackInventoryByDefault`](/api-reference/miscellaneous/objects/shop.mdx#trackinventorybydefaultboolean) 
