...
- If you use the [`checkoutCreate`](docs/api-reference/checkout/mutations/checkout-create.mdx) mutation including the authentication token, this checkout is assigned to the user who is authenticated by this token. For more information on how to authenticate with our API, see the [Authentication](users.mdx#authentication) topic.
...
The [transactionCreate](docs/api-reference/payments/mutations/transaction-create.mdx) mutation takes the following arguments:
...
The following example shows how the [transactionCreate](docs/api-reference/payments/mutations/transaction-create.mdx) mutation
...
:::
The [transactionUpdate](docs/api-reference/payments/mutations/transaction-update.mdx) mutation allows to update the details of the transaction.
...
The following example shows how the [transactionUpdate](docs/api-reference/payments/mutations/transaction-create.mdx) mutation
