...
:::note
The fields for shipping and billing addresses will be normalized (if needed) on completing the checkout by calling [checkoutComplete](developer/api-reference/mutations/checkout-complete.mdx) mutation.
:::
