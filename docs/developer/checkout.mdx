...
Currently, [CheckoutLineUpdateInput](api-reference/inputs/checkout-line-update-input) supports `variantId` and `lineId` parameters to operate on selected line object.
