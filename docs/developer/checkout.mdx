...
:::note
The shipping and billing addresses need to be valid, when finalinzg checkout by calling [checkoutComplete](developer/api-reference/mutations/checkout-complete.mdx) mutation.
:::
