...
4. No additional actions are required by PSP vendor.
...
- `confirmationData`: confirmation data used to process additional authorization steps, required by PSP vendor.
- `checkoutErrors`: a list of errors that occurred during mutation execution.
