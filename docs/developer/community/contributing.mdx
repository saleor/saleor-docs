...
The main rule is not to overload test files. Always, smaller files are preferable over big ones where lots of logic is tested, and it's hard to extend.
