...
Once the feature request is approved by the Saleor's Team, you will be asked to create a new Feature Request issue in the corresponding repository.
...
Once the feature request is approved by the Saleor's Team, it will be labeled with the `accepted` tag, hence making it eligible for a Pull Request.
