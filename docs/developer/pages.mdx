...
- [`PAGE_TYPE_CREATED`](/api-reference/page-type/objects/page-type-created)
- [`PAGE_TYPE_UPDATED`](/api-reference/page-type/objects/page-type-updated)
- [`PAGE_TYPE_DELETED`](/api-reference/page-type/objects/page-type-deleted)
- [`PAGE_CREATED`](/api-reference/page/objects/page-created)
- [`PAGE_UPDATED`](/api-reference/page/objects/page-updated)
- [`PAGE_DELETED`](/api-reference/page/objects/page-deleted)
