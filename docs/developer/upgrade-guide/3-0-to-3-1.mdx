...
You can now use your Apps as extensions throughout the Dashboard. For more information and mounting points, see the the [documentation](https://docs.saleor.io/docs/3.0/developer/extending/apps/extending-dashboard-with-apps).
