...
You can now use your Apps as extensions throughout the Dashboard. For more information and mounting points, see the the [documentation](developer/extending/apps/extending-dashboard-with-apps.mdx).
