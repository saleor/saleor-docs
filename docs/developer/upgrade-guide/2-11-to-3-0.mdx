...
The signature of JWT tokens has been replaced from HS256 to RS256. This change will require providing [RSA private key](developer/running-saleor/configuration.mdx#rsa_private_key) for the production environments.
