...
:::caution
We are in the process of deprecating plugins in favor of [apps](developer/extending/apps/index.mdx). If you plan on building a new integration with Saleor, we recommend using apps instead.
:::
...
- _Adyen_
- [_AdminEmails_](developer/available-plugins/admin-emails.mdx)
- _Authorize.Net_
- _Avalara_
- _Braintree_
- [_Dummy Credit Card_](developer/available-plugins/dummy-credit-card.mdx)
- _Dummy Gateway_
- _Invoicing_
- _NP Atobarai_
- [_OpenID Connect_](developer/available-plugins/oidc.mdx)
- _Razorpay_
- _Stripe_
- [_UserEmails_](developer/available-plugins/user-emails.mdx)
- _Vatlayer_
- _Webhooks_
