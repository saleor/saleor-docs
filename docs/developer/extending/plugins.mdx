...
:::caution
We are in the process of deprecating plugins in favor of [apps](developer/extending/apps/key-concepts.mdx). If you plan on building a new integration with Saleor, we recommend using apps instead.
:::
