...
The breaker states can be observed on the `App` type using the following fields: [App.breakerState](/api-reference/apps/objects/app.mdx#breakerstatecircuitbreakerstateenum) and [App.breakerLastStateChange](/api-reference/apps/objects/app.mdx#breakerlaststatechangedatetime).
