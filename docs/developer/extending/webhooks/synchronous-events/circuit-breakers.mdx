...
The breaker states can be observed on the `App` type using the following fields: [App.breakerState](/api-reference/apps/objects/app.mdx#breaker-state) and [App.breakerLastStateChange](/api-reference/apps/objects/app.mdx#breaker-last-state-change).
