...
webhook by using the [`TransactionChargeRequested`](/api-reference/payments/objects/transaction-charge-requested.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.
...
[`CHARGE_SUCCESS`](/api-reference/payments/enums/transaction-event-type-enum.mdx#charge-success)
or [`CHARGE_FAILURE`](/api-reference/payments/enums/transaction-event-type-enum.mdx#charge-failure)).
...
```json
{
  ...
  "amount": "<[Optional] Decimal amount of the processed action>",
...
Saleor will send a
[`TRANSACTION_CANCEL_REQUESTED`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#transaction-cancelation-requested)
webhook by using the [`TransactionCancelationRequested`](/api-reference/payments/objects/transaction-cancelation-requested.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.
You can find more details about building webhook subscription query
[here](/developer/extending/webhooks/subscription-webhook-payloads.mdx).
...
[`CANCEL_SUCCESS`](/api-reference/payments/enums/transaction-event-type-enum.mdx#cancel-success)
or [`CANCEL_FAILURE`](/api-reference/payments/enums/transaction-event-type-enum.mdx#cancel-failure)). 
If the `amount` field is not provided, Saleor will default to using the requested amount from the original payload.
...
webhook by using the [`TransactionRefundRequested`](/api-reference/payments/objects/transaction-refund-requested.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.

More details about building webhook subscription queries can be found in [subscription webhook payloads](../subscription-webhook-payloads.mdx).
...
The field will contain OrderGrantedRefund when a refund request was triggered by calling [`transactionRequestRefundForGrantedRefund`](/api-reference/payments/mutations/transaction-request-refund-for-granted-refund.mdx) mutation.
...
[`REFUND_SUCCESS`](/api-reference/payments/enums/transaction-event-type-enum.mdx#refund-success)
or [`REFUND_FAILURE`](/api-reference/payments/enums/transaction-event-type-enum.mdx#refund-failure)).
If the `amount` field is not provided, Saleor will default to using the requested amount from the original payload.
...
The synchronous [`PAYMENT_GATEWAY_INITIALIZE_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#payment-gateway-initialize-session)
...
Saleor will send a
[`PAYMENT_GATEWAY_INITIALIZE_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#payment-gateway-initialize-session)
...
The synchronous [`TRANSACTION_INITIALIZE_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#transaction-initialize-session) webhook
...
Saleor will send a
[`TRANSACTION_INITIALIZE_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#transaction-initialize-session)
...
The [`TRANSACTION_PROCESS_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#transaction-process-session) webhook is called synchronously when
...
Saleor will send a
[`TRANSACTION_PROCESS_SESSION`](/api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#transaction-process-session)
