...
See the example payload sent from Saleor for these payment events: [Payment actions payload](/developer/extending/webhooks/sample-webhook-payloads.mdx#payment-actions-payload).
