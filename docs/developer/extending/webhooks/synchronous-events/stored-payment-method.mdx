...
A synchronous webhook [STORED_PAYMENT_METHOD_DELETE_REQUESTED](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbstored_payment_method_delete_requestedbcode) is called when the user requests the deletion of the stored payment method. User can request the deletion of stored payment method by triggering the mutation [storedPaymentMethodRequestDelete](api-reference/payments/mutations/stored-payment-method-request-delete.mdx).
More details about flow can be found [here](developer/payments.mdx#requesting-deletion-of-stored-payment-method).

### Request

The example below shows a sample webhook subscription defined for
[STORED_PAYMENT_METHOD_DELETE_REQUESTED](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbstored_payment_method_delete_requestedbcode)
webhook:
...
The synchronous [PAYMENT_GATEWAY_INITIALIZE_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_gateway_initialize_tokenization_sessionbcode) webhook is triggered when a customer requests the initialization of the payment gateway to tokenize a payment method. This webhook is activated by executing the [paymentGatewayInitializeTokenization](api-reference/payments/mutations/payment-gateway-initialize-tokenization.mdx) mutation.

The webhook payload includes details about the [customer](api-reference/payments/objects/payment-gateway-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentgatewayinitializetokenizationsessionbuserbcodeuser--), [channel](api-reference/payments/objects/payment-gateway-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentgatewayinitializetokenizationsessionbchannelbcodechannel--), and [data](api-reference/payments/objects/payment-gateway-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentgatewayinitializetokenizationsessionbdatabcodejson-). The [data](api-reference/payments/mutations/payment-gateway-initialize-tokenization.mdx#code-style-fontweight-normal-paymentgatewayinitializetokenizationbdatabcodejson-) field contains the JSON data provided as input in the [paymentGatewayInitializeTokenization](api-reference/payments/mutations/payment-gateway-initialize-tokenization.mdx) mutation.
...
Saleor will send a [PAYMENT_GATEWAY_INITIALIZE_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_gateway_initialize_tokenization_sessionbcode) webhook using the [PaymentGatewayInitializeTokenizationSession](api-reference/payments/objects/payment-gateway-initialize-tokenization-session.mdx) subscription type or with a predefined payload in case of a missing subscription query.
...
The application should return the status of the initialization and optionally `data` required to finalize the initialization on the storefront side.
...
The `result` field is an enum value of [PaymentGatewayInitializeTokenizationResultEnum](api-reference/payments/enums/payment-gateway-initialize-tokenization-result.mdx). In the event of returning a failure `result`, the `error` message will be attached to the [error](api-reference/payments/objects/payment-gateway-initialize-tokenization.mdx#code-style-fontweight-normal-paymentgatewayinitializetokenizationberrorsbcodepaymentgatewayinitializetokenizationerror--) returned by the [paymentGatewayInitializeTokenization](api-reference/payments/mutations/payment-gateway-initialize-tokenization.mdx) mutation.
...
The synchronous [PAYMENT_METHOD_INITIALIZE_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_method_initialize_tokenization_sessionbcode) webhook is triggered when a customer requests the tokenization of a payment method. This webhook is activated by executing the [paymentMethodInitializeTokenization](api-reference/payments/mutations/payment-method-initialize-tokenization.mdx) mutation.

The webhook payload includes details about the [customer](api-reference/payments/objects/payment-method-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentmethodinitializetokenizationsessionbuserbcodeuser--), [channel](api-reference/payments/objects/payment-method-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentmethodinitializetokenizationsessionbchannelbcodechannel--), and [data](api-reference/payments/objects/payment-method-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentmethodinitializetokenizationsessionbdatabcodejson-). The [data](api-reference/payments/objects/payment-method-initialize-tokenization-session.mdx#code-style-fontweight-normal-paymentmethodinitializetokenizationsessionbdatabcodejson-) field contains the JSON data provided as input in the [paymentMethodInitializeTokenization](api-reference/payments/mutations/payment-method-initialize-tokenization.mdx) mutation.
...
Saleor will send a [PAYMENT_METHOD_INITIALIZE_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_method_initialize_tokenization_sessionbcode) webhook using the `PaymentMethodInitializeTokenizationSession` subscription type or with a predefined payload in case of a missing subscription query.
...
- A response indicating successful tokenization should include the `result`, the `id` of the stored payment method, and optionally `data` to be passed to the storefront:
...
The `result` field is an enum value of [PaymentMethodTokenizationResultEnum](api-reference/payments/enums/payment-method-tokenization-result.mdx). In case of a failure `result`, the `error` message will be attached to the [error](api-reference/payments/objects/payment-method-initialize-tokenization.mdx#code-style-fontweight-normal-paymentmethodinitializetokenizationberrorsbcodepaymentmethodinitializetokenizationerror--) returned by the [paymentMethodInitializeTokenization](api-reference/payments/mutations/payment-method-initialize-tokenization.mdx) mutation.
...
The synchronous [PAYMENT_METHOD_PROCESS_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_method_process_tokenization_sessionbcode) webhook is triggered when a customer requests to process additional actions required for tokenizing the payment method. This webhook is activated by executing the `paymentMethodProcessTokenization` mutation.
...
Saleor will send a [PAYMENT_METHOD_PROCESS_TOKENIZATION_SESSION](api-reference/webhooks/enums/webhook-event-type-sync-enum.mdx#code-style-fontweight-normal-webhookeventtypesyncenumbpayment_method_process_tokenization_sessionbcode) webhook using the [PaymentMethodProcessTokenizationSession](api-reference/payments/mutations/payment-method-initialize-tokenization.mdx) subscription type or with a predefined payload in case of a missing subscription query.
...
The `result` field is an enum value of [PaymentMethodTokenizationResultEnum](api-reference/payments/enums/payment-method-tokenization-result.mdx). In case of a failure `result`, the `error` message will be attached to the [error](api-reference/payments/objects/payment-method-process-tokenization.mdx#code-style-fontweight-normal-paymentmethodprocesstokenizationberrorsbcodepaymentmethodprocesstokenizationerror--) returned by the [paymentMethodProcessTokenization](api-reference/payments/objects/payment-method-process-tokenization.mdx#code-style-fontweight-normal-paymentmethodprocesstokenizationberrorsbcodepaymentmethodprocesstokenizationerror--) mutation.
