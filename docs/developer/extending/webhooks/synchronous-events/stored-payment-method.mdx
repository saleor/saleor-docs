...
More details about flow can be found [here](docs/developer/payments.mdx#requesting-deletion-of-stored-payment-method).
...
```json
{
  "success": "<Boolean, determine the status of the requested action.>",
  "message": "<Optionall, message that will be passed to the frontend>"
}
```
