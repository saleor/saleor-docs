...
To create a webhook, you first need to create a local app. This can be done in two ways:

- **Using the API:** by executing the [`appCreate`](/api-reference/apps/mutations/app-create.mdx) GraphQL mutation.
- **Using the Dashboard:** by navigating to the **Extentions** section, clicking **Add Extention** -> **Provide details manually**.
