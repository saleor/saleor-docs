...
Some operations can contain more than one synchronous webhook invocations. Saleor can't guarantee successful processing if summary of entire graphQL request exceeds 30s.
