...
Webhooks can be created using the Saleor Dashboard or the Saleor GraphQL API. Both methods trigger the [`webhookCreate`](/api-reference/webhooks/mutations/webhook-create.mdx) mutation.
