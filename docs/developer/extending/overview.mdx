...
You might be tempted to just alter small bits of logic and hope to be able to merge updates in the future.
...
Here are some of the examples how API keys can be used:
