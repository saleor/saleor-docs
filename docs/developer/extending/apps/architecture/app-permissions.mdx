...
Apps cannot be given `MANAGE_STAFF` permission. We chose this design because of the security implications - for example, an app could create a new staff user with administrator rights, outreaching its own permissions.
