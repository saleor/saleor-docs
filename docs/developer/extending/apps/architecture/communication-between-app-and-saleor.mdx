...
Apps can also communicate with Saleor GraphQL API. You can declare the access scope with the app's [permissions](developer/extending/apps/index.mdx#permissions).
