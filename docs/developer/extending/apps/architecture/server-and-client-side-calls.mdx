...
if it wants to consume the Saleor API. Official Saleor Apps and [app-sdk](../developing-apps/app-sdk.mdx) uses [APL concept](./apl.mdx) to store the token.
...
AccessToken is unique for the user - it stores user and permissions in it's payload.
...
Read more in [app-sdk docs](https://github.com/saleor/saleor-app-sdk/blob/main/docs/protected-handlers.md)
...
You can read more [here](https://github.com/saleor/saleor-app-sdk/blob/main/docs/saleor-webhook.md)
