...
<div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
    ...
    <CompactCard
        name="Stripe"
        description="Example impelementation of Stripe integration using Transaction API."
        technology="Next.js"
    ...
    <CompactCard
        name="Klarna"
        description="Example impelementation of Klarna integration using Transaction API."
        technology="Next.js"
