...
Apps are one of the classes implementing [ObjectWithMetadata](api-reference/interfaces/object-with-metadata.mdx) interface, which can be used to store additional data in the Saleor database.
