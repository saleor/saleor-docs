...
[Saleor App Store](../../app-store/overview) is the best display of what apps are. It is a Saleor Cloud feature that allows adding integrations to your Saleor instance with a single click.
