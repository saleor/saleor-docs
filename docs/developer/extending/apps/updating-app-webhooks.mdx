...
While your implementation may differ, the process will roughly stay the same. If you need further inspiration, feel free to peak into [saleor/apps repository](https://github.com/saleor/apps/tree/main/apps/taxes/scripts/migrations).
