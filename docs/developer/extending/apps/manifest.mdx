...
- `webhooks`: List of webhooks that will be set. For details, please see [webhooks](developer/extending/apps/asynchronous-webhooks.mdx) and [webhooks' subscription](developer/extending/apps/subscription-webhook-payloads.mdx) sections.
