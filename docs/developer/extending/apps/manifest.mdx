...
- `extensions`: List of extensions that will be mounted in Saleor's dashboard. For details, please see the [extension section](developer/extending/apps/extensions.mdx#key-concepts)