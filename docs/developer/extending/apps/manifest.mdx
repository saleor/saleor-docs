...
- `tokenTargetUrl`: Endpoint used during process of app installation, see [installing an app.](developer/extending/apps/creating-and-installing-apps-from-the-command-line.mdx#installing-an-app)
