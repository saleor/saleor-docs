...
These webhooks are ran from Saleor Core instance during GraphQL requests and response data will be passed to the client.
...
To react to payment webhooks, first you need to create an app. You can follow as described in [this dashboard manual](/dashboard/apps.md) for regular app, or [read more](developer/extending/apps/introduction.mdx) about different app types.
