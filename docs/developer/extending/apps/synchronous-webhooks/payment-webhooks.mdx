...
First, you need to create an App to react to payment webhooks. You can follow the description in [this dashboard manual](/dashboard/apps.md) for a regular App, or [read more](developer/extending/apps/key-concepts.mdx) about different App types.
