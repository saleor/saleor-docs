...
webhook by using the [PaymentGatewayInitializeSession](api-reference/miscellaneous/objects/payment-gateway-initialize-session.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.
...
webhook by using the [TransactionInitializeSession](api-reference/miscellaneous/objects/transaction-initialize-session.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.
...
webhook by using the [TransactionProcessSession](/api-reference/miscellaneous/objects/transaction-process-session.mdx) subscription type or with a pre-defined payload in case of a missing subscription query.
