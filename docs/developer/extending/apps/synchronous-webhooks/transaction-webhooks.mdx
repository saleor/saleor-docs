...
webhook by using the [TransactionChargeRequested](../../../../api-reference/objects/transaction-charge-requested) subscription type or with a pre-defined payload in case of a missing subscription query.
...
webhook by using the [TransactionCancelationRequested](../../../../api-reference/objects/transaction-cancelation-requested) subscription type or with a pre-defined payload in case of a missing subscription query.
You can find more details about building webhook subscription query
[here](../../../extending/apps/subscription-webhook-payloads).
...
webhook by using the [TransactionRefundRequested](../../../../api-reference/objects/transaction-refund-requested) subscription type or with a pre-defined payload in case of a missing subscription query.
