...
|  ORDER_DETAILS_MORE_ACTIONS   |  Mount extension on order's detail page under a more action button.  |
|     ORDER_OVERVIEW_CREATE     |     Mount extension on order's list page under a create button.      |
|  ORDER_OVERVIEW_MORE_ACTIONS  |   Mount extension on order's list page under a more action button.   |
