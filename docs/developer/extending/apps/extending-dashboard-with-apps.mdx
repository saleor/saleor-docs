...
You can easily access all the fields with JavaScript, like this:
...
|-----------------------------------|---------------------------------------------------------|-------------------------------------------|----------------|
| CATEGORY_OVERVIEW_CREATE          | Category's list page under the create button.           | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| CATEGORY_OVERVIEW_MORE_ACTIONS    | Category's list page under the more action button.      | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| CATEGORY_DETAILS_MORE_ACTIONS     | Category's detail page under the more action button.    | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| COLLECTION_OVERVIEW_CREATE        | Collection's list page under the create button.         | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| COLLECTION_OVERVIEW_MORE_ACTIONS  | Collection's list page under the more action button.    | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| COLLECTION_DETAILS_MORE_ACTIONS   | Collection's detail page under the more action button.  | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| COLLECTION_DETAILS_WIDGETS        | A widget on collection's detail page.                   | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| GIFT_CARD_OVERVIEW_CREATE         | gift card's list page under the create button.          | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| GIFT_CARD_OVERVIEW_MORE_ACTIONS   | gift card's list page under the more action button.     | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| GIFT_CARD_DETAILS_MORE_ACTIONS    | gift card's detail page under the more action button.   | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| GIFT_CARD_DETAILS_WIDGETS         | A widget on gift card's detail page.                    | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| CUSTOMER_OVERVIEW_CREATE          | customer's list page under the create button.           | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| CUSTOMER_OVERVIEW_MORE_ACTIONS    | customer's list page under the more action button.      | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| CUSTOMER_DETAILS_MORE_ACTIONS     | customer's detail page under the more action button.    | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| CUSTOMER_DETAILS_WIDGETS          | A widget on customer's detail page.                     | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| PRODUCT_OVERVIEW_CREATE           | Product's list page under the create button.            | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| PRODUCT_OVERVIEW_MORE_ACTIONS     | Product's list page under the more action button.       | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| PRODUCT_DETAILS_MORE_ACTIONS      | Product's detail page under the more action button.     | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| PRODUCT_DETAILS_WIDGETS           | A widget on product's detail page.                      | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| NAVIGATION_CATALOG                | Catalogs section in the navigation bar.                 | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| NAVIGATION_ORDERS                 | Orders section in the navigation bar.                   | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| NAVIGATION_CUSTOMERS              | Customers section in the navigation bar.                | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| NAVIGATION_DISCOUNTS              | Discounts section in the navigation bar.                | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| NAVIGATION_TRANSLATIONS           | Translations section in the navigation bar.             | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| NAVIGATION_PAGES                  | Pages section in the navigation bar.                    | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| ORDER_DETAILS_MORE_ACTIONS        | Order's detail page under the more action button.       | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| ORDER_OVERVIEW_CREATE             | Order's list page under the create button.              | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| ORDER_OVERVIEW_MORE_ACTIONS       | Order's list page under the more action button.         | `PUPUP`, `APP_PAGE`, `NEW_TAB`            |                |
| ORDER_DETAILS_WIDGETS             | A widget on order's detail page.                        | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| DRAFT_ORDER_DETAILS_MORE_ACTIONS  | Draft order's detail page under the more action button. | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| DRAFT_ORDER_OVERVIEW_CREATE       | Draft order's list page under the create button.        | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| DRAFT_ORDER_OVERVIEW_MORE_ACTIONS | Draft order's list page under the more action button.   | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| DRAFT_ORDER_DETAILS_WIDGETS       | A widget on draft order's detail page.                  | `PUPUP`, `APP_PAGE`, `NEW_TAB`, `WIDGET`  | 3.22           |
| DISCOUNT_DETAILS_MORE_ACTIONS     | Discount's detail page under the more action button.    | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| DISCOUNT_OVERVIEW_CREATE          | Discount's list page under the create button.           | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| DISCOUNT_OVERVIEW_MORE_ACTIONS    | Discount's list page under the more action button.      | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| VOUCHER_DETAILS_MORE_ACTIONS      | Voucher's detail page under the more action button.     | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| VOUCHER_OVERVIEW_CREATE           | Voucher's list page under the create button.            | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| VOUCHER_OVERVIEW_MORE_ACTIONS     | Voucher's list page under the more action button.       | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| VOUCHER_DETAILS_WIDGETS           | A widget on voucher's detail page.                      | `PUPUP`, `APP_PAGE`, `NEW_TAB` , `WIDGET` | 3.22           |
| PAGE_DETAILS_MORE_ACTIONS         | Page's detail page under the more action button.        | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| PAGE_OVERVIEW_CREATE              | Page's list page under the create button.               | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| PAGE_OVERVIEW_MORE_ACTIONS        | Page's list page under the more action button.          | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| PAGE_TYPE_OVERVIEW_CREATE         | Page type's list page under the create button.          | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| PAGE_TYPE_OVERVIEW_MORE_ACTIONS   | Page type's list page under the more action button.     | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| PAGE_TYPE_DETAILS_MORE_ACTIONS    | Page type's detail page under the more action button.   | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| MENU_OVERVIEW_CREATE              | Menu's list page under the create button.               | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| MENU_OVERVIEW_MORE_ACTIONS        | Menu's list page under the more action button.          | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |
| MENU_DETAILS_MORE_ACTIONS         | Menu's detail page under the more action button.        | `PUPUP`, `APP_PAGE`, `NEW_TAB`            | 3.22           |

## More resources

- [app-template](todo): minimal starter boilerplate, containing extensions example implementation
- [build an extension guide](./developing-apps/build-dashboard-extension.mdx): a recipe how to build an extension in Next.js