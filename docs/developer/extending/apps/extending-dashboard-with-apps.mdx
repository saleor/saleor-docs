...
- `permissions`: An array of [permissions](developer/permissions.mdx#app-permissions) required for a user to access the extension. Extension permissions must be a subset of the App permissions.
