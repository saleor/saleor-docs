...
| `GIFT_CARD_SENT`                | A gift card is sent.                                                                                                                                                                                                              |
...
| `PRODUCT_MEDIA_CREATED`         | A new product media is created.                                                                                                                                                                                                   |
| `PRODUCT_MEDIA_DELETED`         | A product media is deleted.                                                                                                                                                                                                       |
| `PRODUCT_MEDIA_UPDATED`         | A product media is updated.                                                                                                                                                                                                       |
| `NOTIFY`                        | Trigger notification to user.                                                                                                                                                                                                     |
| `THUMBNAIL_CREATED`             | A thumbnail is created.                                                                                                                                                                                                           |
...
- `query`: subscription query used to define a webhook payload
- `customHeaders`: custom headers, which will be added to HTTP request
...
mutation {
  webhookCreate(
    input: {
      ...
      app: "QXBwOjk="
      isActive: true
      query: "subscription {  event {    ... on OrderCreated {      order {        id        created      }    }  }}"
