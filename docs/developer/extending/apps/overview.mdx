...
Apps allow you to add new functionality to Saleor and integrate it with third-party services.

Apps can be [installed, managed, and rendered in Saleor Dashboard](extending-dashboard-with-apps).

Technically, Apps are technology-agnostic clients that communicate with Saleor through webhooks and API.
