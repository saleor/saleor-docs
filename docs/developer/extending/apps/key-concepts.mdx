...
To ensure that the incoming webhook payload is from the known host, Saleor adds `Saleor-Signature` header to the request. [Read more](developer/extending/apps/asynchronous-webhooks.mdx#https).
