...
Saleor CLI provides developers with a modern (built with Next.js and TypeScript) app template. It includes all the boilerplate and dependencies needed to further develop a Saleor app.
