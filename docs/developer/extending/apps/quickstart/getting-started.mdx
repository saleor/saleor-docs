---
title: Getting started with Saleor Apps
---

## Introduction to Saloer Apps building
...
:::tip
Are you unsure about what a Saleor app is? You can find more information about them [here](developer/extending/apps/overview.mdx).
:::
...
In this tutorial, we will use [Saleor CLI](cli/overview.mdx) to spawn the app boilerplate.

If you haven't installed Saleor CLI, please head over to the [Saleor CLI documentation](/cli/overview.mdx) for the [installation instructions](/cli/overview.mdx#installing-the-cli).
