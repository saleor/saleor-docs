...
- Prioritize warehouses by sorting order (`PRIORITIZE_SORTING_ORDER`) - allocate stocks
  ...
  [`channelReorderWarehouses`](api-reference/mutations/channel-reorder-warehouses.mdx) mutation.
...
[`createWarehouse`](api-reference/mutations/create-warehouse.mdx) mutation.
...
the [`updateWarehouse`](api-reference/mutations/update-warehouse.mdx) mutation.
...
[`channelUpdate`](api-reference/mutations/channel-update.mdx) mutation.
...
To create the shipping zone use [`shippingZoneCreate`](api-reference/mutations/shipping-zone-create.mdx) mutation.
...
To update the shipping zone use [`shippingZoneUpdate`](api-reference/mutations/shipping-zone-update.mdx) mutation.
