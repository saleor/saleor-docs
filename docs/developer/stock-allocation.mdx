...
We can define warehouse as public or private. Public warehouse allows you to query the stock information publicly in the API. Private warehouse requires permission. [`quantityAvailable`](api-reference/products/objects/product-variant.mdx#productvariantquantityavailableint--) is the sum of the available quantity in all public and private warehouses.
