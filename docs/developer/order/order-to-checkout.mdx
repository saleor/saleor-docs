...
[ID](/api-reference/checkout/mutations/checkout-create-from-order.mdx#idid)
as input and returns the new [checkout](/api-reference/checkout/objects/checkout-create-from-order.mdx#checkoutcheckout),
...
[`unavailableVariants`](/api-reference/checkout/objects/checkout-create-from-order.mdx#unavailablevariantscheckoutcreatefromorderunavailablevariant).
...
- [`code`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#codecheckoutcreatefromorderunavailablevarianterrorcode) that describes why Saleor could not add it to the checkout.
- [`variantId`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#variantidid) that contains the ID of the unavailable variant.
- [`lineId`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#lineidid) that contains the ID of the related `orderLine`.
- [`message`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#messagestring) the error message.
