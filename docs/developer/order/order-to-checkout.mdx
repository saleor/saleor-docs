...
[ID](/api-reference/checkout/mutations/checkout-create-from-order.mdx#id)
as input and returns the new [checkout](/api-reference/checkout/objects/checkout-create-from-order.mdx#checkout),
...
[`unavailableVariants`](/api-reference/checkout/objects/checkout-create-from-order.mdx#unavailable-variants).
...
- [`code`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#code) that describes why Saleor could not add it to the checkout.
- [`variantId`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#variant-id) that contains the ID of the unavailable variant.
- [`lineId`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#line-id) that contains the ID of the related `orderLine`.
- [`message`](/api-reference/checkout/objects/checkout-create-from-order-unavailable-variant.mdx#message) the error message.
