...
For orders paid using payment plugins, use [`orderFulfillmentRefundProducts`](/api-reference/orders/mutations/order-fulfillment-refund-products.mdx) or [`orderRefund`](/api-reference/orders/mutations/order-refund.mdx).
:::
...
2. **Miscellaneous Refund** 
   ...
   - Fulfillment: Already shipped
   - Plugin-based: Use [`orderRefund`](/api-reference/orders/mutations/order-refund.mdx) to refund a custom amount (e.g., shipping costs)
