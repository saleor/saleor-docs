...
Saleor uses redirect 3D Secure 1 and 2 by default. To use native 3DS, [enable it in the Saleor dashboard](dashboard/configuration/plugins/adyen.md#enabling-the-adyen-integration). 
