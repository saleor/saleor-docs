...
:::warning
If your checkout is transformed into an order during this step, please make sure that in a given channel, [`allowUnpaidOrders`](/api-reference/miscellaneous/objects/order-settings.mdx#allowunpaidordersboolean) setting is turned off.
