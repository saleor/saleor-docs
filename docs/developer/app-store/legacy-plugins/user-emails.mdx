...
If you plan on building a new integration with Saleor, we recommend using the [SMTP](../apps/smtp/overview) app or [Sendgrid](https://github.com/saleor/example-app-sendgrid) example app instead.
:::
