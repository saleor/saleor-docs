...
If you plan on building a new integration with Saleor, use [Customer Emails](../apps/customer-emails/overview) on Saleor Cloud, or the [SMTP](../apps/smtp/overview) app if you are self-hosting.
:::
