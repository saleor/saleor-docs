...
There is an [example testclient where you want to add the Segment NEXT_PUBLIC_SEGMENT_WRITE_KEY](https://github.com/saleor/adyen-app-testclient/tree/segment-analitics).
...
In customer.io you want to setup a campaing with the following workflow
![](./assets/customerio-workflow.jpg)


### Customer.io e-mail template
And in the e-mail tenplate you can use the fields related to the basket someone has has in progress:
```
