...
`availablePaymentGateways` may contain other Payment Apps as well as older [Payment Gateways (plugins)](../../../developer/extending/payment-gateways) configured in the Dashboard. You should ignore the ones that you don't support.
