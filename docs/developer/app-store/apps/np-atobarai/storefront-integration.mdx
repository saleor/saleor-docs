...
Saleor will automatically generate the Idempotency Key. If you want to control the Key usage, like setting your own, you can pass it to [the mutation](/api-reference/payments/mutations/transaction-initialize.mdx)
