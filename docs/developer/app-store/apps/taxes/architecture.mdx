...
- [`OrderConfirmed`](docs/api-reference/taxes/objects/order-confirmed.mdx)
- [`OrderCreated`](docs/api-reference/taxes/objects/order-created.mdx) (_deprecated in the Taxes App_)
- [`OrderFulfilled`](docs/api-reference/taxes/objects/order-fulfilled.mdx) (_deprecated in the Taxes App_)
...
3. You are planning to fulfill the order after August 23 (which is the date when we will complete the migration).
