...
If that doesn't happen, it's possible that it's an expected AvaTax behavior. There is a number of reasons why AvaTax can return 0 as the tax value and they are all described in the "[Reasons Tax Can Be Zero](https://www.avalara.com/partner/en/api/calculation/sales-tax/guide/exemptions/reasons-tax-can-be-zero.html)" article.
