...
You can check why the taxes were calculated in a certain way in AvaTax dashboard. Once the Checkout is completed and converted into an Order it will be visible in AvaTax under Transactions tab.
...
The invocie will have line items from Saleor order. Clicking on line item will reveal more details about the taxes:

![Line item details in AvaTax dashboard that includes flowchart why taxes were calculated](./avatax-details-1.png)
...
![Review calculation page with information about tax details for particular line item in order](./avatax-details-2.png)
