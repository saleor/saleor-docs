...
You may have use cases where you want to create free orders, such as free samples or free digital downloads.

Adyen Drop-in integration does not support handling payments with a total amount of zero. This may require skipping the payment step and completing the order without a transaction.
