...
The app *stores* and *processes* data that may be PIIs or sensitive:

### Processing

App is retrieving and sending data to Adyen with modification or persisting:

- The IP address of the customer
- Browser data that Adyen drop-in is gathering (app is receiving it from the Storefront and sending it to Adyen). See [Adyen docs](https://docs.adyen.com/online-payments/analytics-and-data-tracking/)
- Saleor customer ID
...
- Adyen PSP reference
- Saleor channel ID
- Flag if the user was logged in
- Adyen response value
