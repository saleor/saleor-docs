...
:::caution
Before you begin configuration, make sure that you have disabled the **Delayed Capture** option in Adyen Dashboard. Read more details how to do this in [Overview docs page](./overview.mdx)
:::

In Adyen dashboard firstly go to **Developers -> Additional data**. Click following checkboxes:
...
To configure additional fields which will be set when users make payments, go to `Developers > Additional data` and choose fields you want to have in your metadata. Read more about this in [Architecture docs page](./architecture.mdx#transactionitem-metadata)
:::
