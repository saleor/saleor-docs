...
It is available on [Saleor Cloud](/cloud/overview.mdx) from Saleor 3.23. If you are self-hosting, or still on 3.22, use the [SMTP app](/developer/app-store/apps/smtp/overview.mdx).
