...
2. **Notifications** — the emails themselves: Order created, Order confirmed, password reset, and the rest. Turn each one on or off, and edit the wording customers get when you have not translated it.
