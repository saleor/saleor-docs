...
:::warning
On Saleor Cloud 3.23+, [Customer Emails](/developer/app-store/apps/customer-emails/overview.mdx) replaces this app for new setups. If you are self-hosting, or still on 3.22, this is the app that sends customer email.
:::
...
Saleor Cloud no longer uses this app for new stores. [Customer Emails](/developer/app-store/apps/customer-emails/overview.mdx) can preview mail to the organization owner until you add your own connection.
