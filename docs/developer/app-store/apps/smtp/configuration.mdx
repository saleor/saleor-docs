...
Starting with version 2.0.0, the app only allows a curated subset of [handlebars-helpers](https://github.com/helpers/handlebars-helpers) for security reasons. Templates that use any other helper will fail validation. The allowed helpers are:
