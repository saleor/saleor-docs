...
If your application or integration doesn't need the `TaxedMoney` type field, don't add it to the GraphQL subscription or query. This way, Saleor won't send webhook requests to the AvaTax app for unnecessary tax calculations, making your integration faster.
