...
![Line item details in AvaTax dashboard that includes a flowchart of why taxes were calculated](./avatax-details-1.png)
...
![Review the calculation page with information about tax details for the particular line item in order](./avatax-details-2.png)
