...
- [Managing document recording](./configuration/overview#document-recording)
- [Mapping the entity type](./configuration/overview#entity-type)
- [Mapping the document code](./configuration/overview#document-code)
