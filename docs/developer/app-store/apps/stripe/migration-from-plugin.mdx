...
You should consider migrating from the [Stripe Plugin](../../legacy-plugins/stripe) to the App. This document will help you with that.
...
| Releasing funds if Order can't be created from checkout | Plugin will release the funds immediately.                                                                  | App will not refund funds, but [Saleor will eventually](/developer/checkout/lifecycle.mdx#releasing-funds-for-abandoned-checkouts) |
