...
App uses the assumptions below to make decisions about its behavior. Changing them will usually mean breaking change, so it's not likely they will change in the future.
