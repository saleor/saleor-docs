...
- Algolia has a limit on the maximum record size. Having too many attributes within the variant can cause the record to be too big. Try to them or use field filtering in the App settings.
