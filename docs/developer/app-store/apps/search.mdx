...
- Initial synchronization has to be done manually in the App dashboard
- The application creates a separate record for each of the variants
...
- Account on [Algolia](https://www.algolia.com/). The free account will be sufficient, but has additional limitations, like maximum record size.
...
The application is now connected to your Algolia account. You can now synchronize your products:
...
The application is now configured and synchronized, you can start making queries using the Algolia API or browse the data in the Algolia dashboard. Changes to the products will be automatically synchronized.
...
[
  {
    ...
    "media": [
      {
        "url": "https://demo.saleor.cloud/media/thumbnails/products/saleor-carrot-drink_thumbnail_4096.png",
        "type": "IMAGE"
      }
    ],
    "description": {
    ...
    "slug": "carrot-juice",
    "thumbnail": "https://demo.saleor.cloud/media/thumbnails/products/saleor-carrot-drink_thumbnail_256.png",
    "grossPrice": 1.99,
    "inStock": true,
    "categories": {
      "lvl0": "Groceries",
