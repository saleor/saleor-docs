...
:::caution
If you plan to use SMTP server, please use the [SMTP app](../smtp/overview) instead.
Emails and Messages app is being split into separate SMTP and Sendgrid apps.
:::
...
To run the application locally, follow the [_Self-hosting Saleor Apps_ article](/developer/extending/apps/developing-apps/self-hosting-saleor-apps).
