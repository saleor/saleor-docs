...
:::note
App is in beta mode. We will continue improving the app once ACP gets more mature and adopted.
:::
...
- App is frontend-only and all logic happens within Saleor Dashboard App page.
