---
title: Product Feed App (Deprecated)
sidebar_label: Product Feed (Deprecated)
description: Product Feed App - deprecated in favour of the Google Merchant Center App
---

import { AppMetadata } from "/components/AppMetadata/AppMetadata.jsx";

<AppMetadata
  minSaleorVersion="3.22 – 3.23"
  githubUrl="https://github.com/saleor/apps/tree/main/apps/products-feed"
/>

:::warning Deprecated

The _Product Feed_ app is deprecated. **Saleor 3.23 is the last version it supports — it does not work on Saleor 3.24 and newer.**

Use the [Google Merchant Center App](./google-merchant-center.mdx) instead: it generates feeds on a schedule at catalog scale, hosts the files for you, and needs no S3 bucket of your own.

See [Migrating from Product Feed](./google-merchant-center.mdx#migrating-from-product-feed) for what carries over.
