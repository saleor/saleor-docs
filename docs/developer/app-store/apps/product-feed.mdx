...
- Set a scheduler in Google Merchant Center
- Separate feed for each of the channels
- Map Saleor attributes to fields like size, material, brand
...
- Data displayed in Google Merchant Center do not update in real-time. This is a limitation of GMC. It may take [up to 3 business days](https://support.google.com/merchants/answer/188477) to update.
...
The app requires `MANAGE_PRODUCTS` permission.
...
- AWS S3 bucket with write access token and public read of the object
