...
>
  <figure style={{ flex: "1 1 280px", margin: 0 }}>
    <img
      src={require("./assets/pulse-financial.png").default}
      alt="Pulse Financial view with KPIs and a net sales trend in the Saleor Dashboard"
    />
    <figcaption>Pulse on Dashboard home — Financial view</figcaption>
  </figure>
  <figure style={{ flex: "1 1 280px", margin: 0 }}>
    <img
      src={require("./assets/product-insights.png").default}
      alt="Product Insights panel on a product page in the Saleor Dashboard"
    />
    <figcaption>Product Insights on a product page</figcaption>
  </figure>
</div>

## Where to Go in Pulse

Pulse is organized around how merchants actually work — explore the numbers, then notice what matters.
...
| <PulseSurface name="product-insights" strong /> | One product, on the product page | How is *this* product selling, and are variants at risk? |
...
Use Financial when you are reviewing revenue, comparing periods, or explaining *why* a number moved.
