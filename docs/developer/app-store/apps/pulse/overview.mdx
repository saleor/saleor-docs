...
- **Origins** — surfaces, campaigns, and sources ranked by net after refunds, when orders carry [Commerce Context](./commerce-context.mdx)
...
- [Commerce Context](./commerce-context.mdx) — write an origin note so Origins can fill
