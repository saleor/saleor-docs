---
sidebar_label: Instant Checkout with ChatGPT (Beta)
title: Instant Checkout with ChatGPT (Beta)
sidebar_position: 6
description: Instant Checkout with ChatGPT (Beta)
---

import { AppMetadata } from "/components/AppMetadata/AppMetadata.jsx";

<AppMetadata minSaleorVersion="3.21" />
...
- Finalizing the checkout with ChatGPT **(coming soon)**
