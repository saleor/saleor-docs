...
Majority of Saleor Apps are open source. Feel free to fork them and host on your own infrastructure. See [Apps directory](developer/app-store/apps/overview.mdx).
