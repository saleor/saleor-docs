...
:::warning
From June 2025, Stripe is charging an extra fee for using Stripe Secret Key in the connected integrations. To avoid these, you should generate Restricted Key and replace it in the Saleor dashboard or use [the App](../apps/stripe/overview)
