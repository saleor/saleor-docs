...
You can download the full Saleor GraphQL schema from the following URL: https://raw.githubusercontent.com/saleor/saleor/3.23/saleor/graphql/schema.graphql
