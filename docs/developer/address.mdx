...
As an example of the address validation API, we will set the billing address in the checkout. The operation can be made with [checkoutBillingAddressUpdate](developer/api-reference/mutations/checkout-billing-address-update.mdx):
