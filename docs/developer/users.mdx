...
## Accessing authorizated user info

[`me`](developer/api-reference/queries/me.mdx) allow you to get information about currently logged in user. 
...
If request is missing `authorization` header or, server will response with `null`.
