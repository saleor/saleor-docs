...
The [transactionUpdate](../api-reference/mutations/transaction-update) mutation allows updating the transaction details.
...
The [transactionUpdate](../api-reference/mutations/transaction-update) can only be called by the transaction owner.
