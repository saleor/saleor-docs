...
- `paymentMethodDetails` - the payment method, using the same [`PaymentMethodDetails`](/api-reference/miscellaneous/interfaces/payment-method-details.mdx) types as `TransactionItem`.
