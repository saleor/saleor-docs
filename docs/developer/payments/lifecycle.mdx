...
[`Order.paymentStatus`](/api-reference/orders/objects/order.mdx#payment-status) represents the combined payment and refund status of the order. It's calculated based on:
