...
:::warning
Menus do not have a UI in Saleor Dashboard and must be managed via the API.

If you want to build a UI for managing menus, you can start with the [Example Menu Manager App](https://github.com/saleor/example-app-menu-manager).
:::
...
Menu operations require the [`MANAGE_MENUS`](developer/permissions#available-permissions) permission.
