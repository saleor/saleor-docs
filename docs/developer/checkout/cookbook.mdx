...
If your admins need to manage subscriptions, you can use custom app to create a dedicated UI in the Saleor dashboard that will talk to your subscription service.
