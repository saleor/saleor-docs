...
- Listen to [`webhook`](/developer/extending/webhooks/overview.mdx) such as [`ORDER_CREATED`](/developer/extending/webhooks/synchronous-events/order#order-created) to process the fields
