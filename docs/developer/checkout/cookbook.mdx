...
If your admins need to manage subscriptions, you can use [custom app](/developer/extending/apps/quickstart.mdx) to create a dedicated UI in the Saleor dashboard that will talk to your subscription service.
