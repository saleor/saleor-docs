...
- Field [CheckoutLine.problems](api-storefront/checkout/objects/checkout-line.mdx#checkoutlineproblemscheckoutlineproblem--) returns a list of problems
  related to a specific [CheckoutLine](api-storefront/checkout/objects/checkout-line.mdx).
- Field [Checkout.problems](api-storefront/checkout/objects/checkout.mdx#checkoutproblemscheckoutproblem--) returns a
  list of all problems related to the checkout and [CheckoutLine.problems](api-storefront/checkout/objects/checkout-line.mdx#checkoutlineproblemscheckoutlineproblem--)
...
[Checkout.problems](api-storefront/checkout/objects/checkout.mdx#checkoutproblemscheckoutproblem--) contains the list of all problems
that occurred for the checkout. It also includes the problems that are related to specific lines.

The example below shows query that fetches a [Checkout.problems](api-storefront/checkout/objects/checkout.mdx#checkoutproblemscheckoutproblem--).
...
[CheckoutLine.problems](api-storefront/checkout/objects/checkout-line.mdx#checkoutlineproblemscheckoutlineproblem--) contains the list of problems
that are strictly related to the specific checkout line.
The list of problems will be also attached to [Checkout.problems](api-storefront/checkout/objects/checkout.mdx#checkoutproblemscheckoutproblem--) field.

The example below shows query that fetches a [CheckoutLine.problems](api-storefront/checkout/objects/checkout-line.mdx#checkoutlineproblemscheckoutlineproblem--).
...
for the [quantity](api-storefront/checkout/objects/checkout-line.mdx#checkoutlinequantityint--) assigned to [CheckoutLine](api-storefront/checkout/objects/checkout-line.mdx).
Until resolving the problem, placing the order will not be possible. Mutation for finalizing the checkout like [checkoutComplete](api-storefront/checkout/mutations/checkout-complete.mdx) will return an error [INSUFFICIENT_STOCK](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeinsufficient_stock).
The quantity should be reduced to the value that is less or equal to [CheckoutLineProblemInsufficientStock.availableQuantity](api-storefront/checkout/objects/checkout-line-problem-insufficient-stock.mdx#checkoutlineprobleminsufficientstockavailablequantityint-).
...
the attached [variant](api-storefront/checkout/objects/checkout-line.mdx#checkoutlinevariantproductvariant--) to
...
[PRODUCT_NOT_PUBLISHED](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeproduct_not_published),
[PRODUCT_UNAVAILABLE_FOR_PURCHASE](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeproduct_unavailable_for_purchase),
[UNAVAILABLE_VARIANT_IN_CHANNEL](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeunavailable_variant_in_channel).
...
http://localhost:3000/docs/3.x/api-storefront/checkout/objects/checkout#checkoutproblemscheckoutproblem--
http://localhost:3000/docs/3.x/api-storefront/checkout/objects/checkout-line#checkoutlineproblemscheckoutlineproblem--
...
[INSUFFICIENT_STOCK](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeinsufficient_stock) error.
...
[INSUFFICIENT_STOCK](api-storefront/checkout/enums/checkout-error-code.mdx#checkouterrorcodeinsufficient_stock) error).
Instead, the new problem will be listed as [Checkout.problems](api-storefront/checkout/objects/checkout.mdx#checkoutproblemscheckoutproblem--)
and [CheckoutLine.problems](api-storefront/checkout/objects/checkout-line.mdx#checkoutlineproblemscheckoutlineproblem--)
