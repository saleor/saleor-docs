...
description: Discover how to extend Saleor Dashboard functionality with custom views and integrations.
---
...
- `*_DETAILS_WIDGETS`: Embedded widgets in the entity details sidebar (`WIDGET` target)
