...
## Build-in Shipping Methods

Saleor provides comprehensive tools for defining shipping options directly within the dashboard, often eliminating the need for custom code or external integrations in common scenarios. These built-in methods allow you to flexibly control where you ship, how much you charge, and the conditions under which specific options are available.
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', paddingBottom: '4rem'}}>
    ...
    />
   <CompactCard
        name="Shipping events docs"
        description="Read more about all synchronous shipping events."
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', paddingBottom: '4rem'}}>
    <CompactCard
        ...
        description="Utilities for working with webhooks."
        link="/developer/extending/apps/developing-apps/app-sdk/saleor-webhook"
    />
   <CompactCard
        name="Shipping events docs"
        description="Details on the synchronous app interface."
        link="/developer/extending/webhooks/synchronous-events/shipping"
    />
</div>
...
<div style={{display: 'flex', gap: '1rem', flexWrap: 'wrap', paddingBottom: '4rem'}}>
   ...
   <CompactCard
        name="Fulfillments lifecycle"
        description="How fulfillments change over time."
        link="/developer/order/order-fulfillment"
    />
   <CompactCard
        name="Apps communication strategies"
        description="Patterns of synchronizing status between services."
        link="/developer/extending/apps/architecture/communication-between-app-and-saleor#app-to-saleor-api"
    />
    <CompactCard
        name="External webhooks guide"
        description="Strategies for receiving webhooks in multi-tennant environment."
