...
<Block title="Recipes" >
    <Chapters>
        ...
        [<DollarSign size={16} strokeWidth={1.5}/> **Custom Pricing** _Implement segment pricing, volume discounts, and dynamic pricing strategies._](/recipes/custom-pricing.mdx)
