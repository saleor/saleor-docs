...
Saleor's functionalities enable you to create a marketplace platform where multiple sellers can list their products for sale. This recipe provides a guide to setting up and managing a marketplace in Saleor, covering product and vendor modeling, fulfillment, payments, and vendor management.
...
This approach means that while vendors exist in Saleor as staff users, all vendor-specific access control is handled outside of Saleor.
...
Here is an overview of the essential services that you need to build a marketplace with Saleor:

<img src="/assets/marketplace/1.png" alt="Marketplace Architecture" />