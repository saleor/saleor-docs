...
Zero-downtime migrations can only be achieved by upgrading Saleor minor version by minor version, that means, to upgrade Saleor from version 3.21 to 3.23, you need first upgrade your workers
to version 3.22, then proceed with upgrading to version 3.23. By upgrading from version 3.21 directly to 3.23 you will not follow zero-downtime policy.
