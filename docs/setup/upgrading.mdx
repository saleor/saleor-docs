...
For instruction regarding zero-downtime migrations, see the [upgrading with zero-downtime migrations guide](../developer/community/zero-downtime-migrations#upgrading-with-zero-downtime-migrations).
