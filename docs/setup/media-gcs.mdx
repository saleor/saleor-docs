...
- Return the HTTP header `Content-Disposition: attachment` for all assets.
- Do not make the buckets publicly accessible (such as allowing anyone to list the assets).
