...
Dashboard versioning follows the same pattern as the Core. Minor versions of the Dashboard are compatible with the same minor version of the Core. For example, Dashboard version 3.23 is compatible with Core version 3.23.
