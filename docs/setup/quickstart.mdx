...
The underlying technology is [saleor/storefront](https://github.com/saleor/storefront). It was built using Next.js with App Router, TypeScript, and Tailwind CSS.
