...
_Looking to report a security issue instead? See our [Security Policy]._
...
## Restricting Public API Access

The `Shop.allowStorefrontTraffic` setting lets you close the GraphQL API to unauthenticated & unprivileged users, leaving it reachable only by apps and staff users. See [Blocking storefront traffic](../api-usage/authentication.mdx#blocking-storefront-traffic).
