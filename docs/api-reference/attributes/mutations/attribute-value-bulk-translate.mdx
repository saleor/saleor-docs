...
#### [<code style={{ fontWeight: 'normal' }}>attributeValueBulkTranslate.<b>errorPolicy</b></code>](#)<Bullet />[`ErrorPolicyEnum`](../../../api-reference/miscellaneous/enums/error-policy-enum) <Badge class="secondary" text="enum"/>

> Policies of error handling. DEFAULT: REJECT_EVERYTHING

#### [<code style={{ fontWeight: 'normal' }}>attributeValueBulkTranslate.<b>translations</b></code>](#)<Bullet />[`[AttributeValueBulkTranslateInput!]!`](../../../api-reference/attributes/inputs/attribute-value-bulk-translate-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
