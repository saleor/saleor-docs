...
#### [<code style={{ fontWeight: 'normal' }}>attributeValueDelete.<b>externalReference</b></code>](#)<Bullet />[`String`](../../../api-reference/miscellaneous/scalars/string) <Badge class="secondary" text="scalar"/>

> External ID of a value to delete.
>
> <Badge text="Added in Saleor 3.10" class="secondary margin-bottom--sm" />

#### [<code style={{ fontWeight: 'normal' }}>attributeValueDelete.<b>id</b></code>](#)<Bullet />[`ID`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="scalar"/>

> ID of a value to delete.

### Type

#### [`AttributeValueDelete`](../../../api-reference/attributes/objects/attribute-value-delete) <Badge class="secondary" text="object"/>
