...
[`AttributeChoicesSortingInput`](/api-reference/attributes/inputs/attribute-choices-sorting-input.mdx) <Badge class="badge badge--secondary badge--relation" text="input"/>
