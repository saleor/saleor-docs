...
[`AttributeCreateInput`](/api-reference/attributes/inputs/attribute-create-input) <mark class="gqlmd-mdx-badge">input</mark><span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[`attributeValueCreate`](/api-reference/attributes/mutations/attribute-value-create) <mark class="gqlmd-mdx-badge">mutation</mark>
