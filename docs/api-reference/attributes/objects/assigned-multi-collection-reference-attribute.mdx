...
#### [<code>value</code>](#value)<Bullet />[<code>[Collection!]!</code>](/api-reference/products/objects/collection.mdx) \{#value\}

List of assigned collection references.

##### [<code>limit</code>](#assigned-multi-collection-reference-attribute-value-limit)<Bullet />[<code>PositiveInt</code>](/api-reference/miscellaneous/scalars/positive-int.mdx) \{#assigned-multi-collection-reference-attribute-value-limit\}
