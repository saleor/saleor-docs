...
#### [<code>value</code>](#)<Bullet />[<code>JSON</code>](/api-reference/miscellaneous/scalars/json.mdx)

The assigned rich text content.

#### [<code>translation</code>](#)<Bullet />[<code>JSON</code>](/api-reference/miscellaneous/scalars/json.mdx)
