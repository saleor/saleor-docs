...
#### [<code>value</code>](#value)<Bullet />[<code>[AssignedChoiceAttributeValue!]!</code>](/api-reference/attributes/objects/assigned-choice-attribute-value.mdx) \{#value\}

List of assigned choice values.

##### [<code>limit</code>](#assigned-multi-choice-attribute-value-limit)<Bullet />[<code>PositiveInt</code>](/api-reference/miscellaneous/scalars/positive-int.mdx) \{#assigned-multi-choice-attribute-value-limit\}
