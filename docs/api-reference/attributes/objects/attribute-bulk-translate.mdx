...
#### [<code>results</code>](#results)<Bullet />[<code>[AttributeBulkTranslateResult!]!</code>](/api-reference/attributes/objects/attribute-bulk-translate-result.mdx) \{#results\}

List of the translations.

#### [<code>errors</code>](#errors)<Bullet />[<code>[AttributeBulkTranslateError!]!</code>](/api-reference/miscellaneous/objects/attribute-bulk-translate-error.mdx) \{#errors\}
