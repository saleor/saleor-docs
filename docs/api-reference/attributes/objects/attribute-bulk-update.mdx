...
#### [`results`](#)<Bullet />[`[AttributeBulkUpdateResult!]!`](/api-reference/attributes/objects/attribute-bulk-update-result.mdx)

List of the updated attributes.

#### [`errors`](#)<Bullet />[`[AttributeBulkUpdateError!]!`](/api-reference/attributes/objects/attribute-bulk-update-error.mdx)
