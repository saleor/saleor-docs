...
#### [<code>results</code>](#results)<Bullet />[<code>[AttributeBulkUpdateResult!]!</code>](/api-reference/attributes/objects/attribute-bulk-update-result.mdx) \{#results\}

List of the updated attributes.

#### [<code>errors</code>](#errors)<Bullet />[<code>[AttributeBulkUpdateError!]!</code>](/api-reference/attributes/objects/attribute-bulk-update-error.mdx) \{#errors\}
