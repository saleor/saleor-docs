...
#### [`default`](#)<Bullet />[`String!`](/api-reference/miscellaneous/scalars/string.mdx)
...
##### [`format`](#)<Bullet />[`IconThumbnailFormatEnum`](/api-reference/miscellaneous/enums/icon-thumbnail-format-enum.mdx)
