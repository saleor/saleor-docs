...
#### [<code style={{ fontWeight: 'normal' }}>AppManifestBrand.<b>logo</b></code>](#)<Bullet />[`AppManifestBrandLogo!`](../../../api-reference/apps/objects/app-manifest-brand-logo) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>
