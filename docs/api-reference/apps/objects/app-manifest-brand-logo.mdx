...
#### [<code style={{ fontWeight: 'normal' }}>AppManifestBrandLogo.<b>default</b></code>](#)<Bullet />[`String!`](../../../api-reference/miscellaneous/scalars/string.mdx) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
...
##### [<code style={{ fontWeight: 'normal' }}>AppManifestBrandLogo.default.<b>format</b></code>](#)<Bullet />[`IconThumbnailFormatEnum`](../../../api-reference/miscellaneous/enums/icon-thumbnail-format-enum.mdx) <Badge class="badge badge--secondary" text="enum"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
