...
#### [<code>appProblem</code>](#)<Bullet />[<code>AppProblem</code>](/api-reference/apps/objects/app-problem.mdx)

The created or updated app problem.

#### [<code>errors</code>](#)<Bullet />[<code>[AppProblemCreateError!]!</code>](/api-reference/miscellaneous/objects/app-problem-create-error.mdx)
