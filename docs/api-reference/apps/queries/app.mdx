...
#### [<code style={{ fontWeight: 'normal' }}>app.<b>id</b></code>](#)<Bullet />[`ID`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="scalar"/>

> ID of the app.

### Type

#### [`App`](../../../api-reference/apps/objects/app) <Badge class="secondary" text="object"/>
