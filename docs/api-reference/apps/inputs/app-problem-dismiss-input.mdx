...
#### [<code>byApp</code>](#by-app)<Bullet />[<code>AppProblemDismissByAppInput</code>](/api-reference/apps/inputs/app-problem-dismiss-by-app-input.mdx) \{#by-app\}

For app callers only - dismiss own problems.

#### [<code>byStaffWithIds</code>](#by-staff-with-ids)<Bullet />[<code>AppProblemDismissByStaffWithIdsInput</code>](/api-reference/apps/inputs/app-problem-dismiss-by-staff-with-ids-input.mdx) \{#by-staff-with-ids\}

For staff callers - dismiss problems by IDs.

#### [<code>byStaffWithKeys</code>](#by-staff-with-keys)<Bullet />[<code>AppProblemDismissByStaffWithKeysInput</code>](/api-reference/apps/inputs/app-problem-dismiss-by-staff-with-keys-input.mdx) \{#by-staff-with-keys\}
