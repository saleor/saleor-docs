...
#### [<code style={{ fontWeight: 'normal' }}>AppInstallInput.<b>appName</b></code>](#)<Bullet />[`String`](../../../api-reference/miscellaneous/scalars/string) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>AppInstallInput.<b>permissions</b></code>](#)<Bullet />[`[PermissionEnum!]`](../../../api-reference/users/enums/permission-enum) <Badge class="secondary" text="list"/> <Badge class="secondary" text="enum"/>
