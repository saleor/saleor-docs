...
#### [<code style={{ fontWeight: 'normal' }}>appTokenDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of an auth token to delete.

### Type

#### [`AppTokenDelete`](../../../api-reference/apps/objects/app-token-delete) <Badge class="secondary" text="object"/>
