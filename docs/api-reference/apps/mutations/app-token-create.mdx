...
#### [<code style={{ fontWeight: 'normal' }}>appTokenCreate.<b>input</b></code>](#)<Bullet />[`AppTokenInput!`](../../../api-reference/apps/inputs/app-token-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to create a new auth token.

### Type

#### [`AppTokenCreate`](../../../api-reference/apps/objects/app-token-create) <Badge class="secondary" text="object"/>
