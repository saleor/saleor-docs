...
#### [<code style={{ fontWeight: 'normal' }}>appTokenCreate.<b>input</b></code>](#)<Bullet />[`AppTokenInput!`](../../../api-reference/apps/inputs/app-token-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to create a new auth token.

### Type

#### [`AppTokenCreate`](../../../api-reference/apps/objects/app-token-create) <Badge class="badge badge--secondary" text="object"/>
