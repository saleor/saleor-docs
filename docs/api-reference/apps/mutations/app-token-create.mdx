...
#### [<code>input</code>](#input)<Bullet />[<code>AppTokenInput!</code>](/api-reference/apps/inputs/app-token-input.mdx) \{#input\}

Fields required to create a new auth token.

### Type

#### [<code>AppTokenCreate</code>](/api-reference/apps/objects/app-token-create.mdx)
