...
#### [<code style={{ fontWeight: 'normal' }}>appActivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of app to activate.

### Type

#### [`AppActivate`](../../../api-reference/apps/objects/app-activate) <Badge class="secondary" text="object"/>
