...
#### [<code style={{ fontWeight: 'normal' }}>appInstall.<b>input</b></code>](#)<Bullet />[`AppInstallInput!`](../../../api-reference/apps/inputs/app-install-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to install a new app.

### Type

#### [`AppInstall`](../../../api-reference/apps/objects/app-install) <Badge class="secondary" text="object"/>
