...
#### [<code style={{ fontWeight: 'normal' }}>appDeleteFailedInstallation.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of failed installation to delete.

### Type

#### [`AppDeleteFailedInstallation`](../../../api-reference/apps/objects/app-delete-failed-installation) <Badge class="badge badge--secondary" text="object"/>
