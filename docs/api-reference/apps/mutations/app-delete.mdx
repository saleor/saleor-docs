...
#### [<code style={{ fontWeight: 'normal' }}>appDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of an app to delete.

### Type

#### [`AppDelete`](../../../api-reference/apps/objects/app-delete) <Badge class="secondary" text="object"/>
