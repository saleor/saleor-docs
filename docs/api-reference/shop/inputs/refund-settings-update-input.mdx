...
#### [<code>refundReasonReferenceType</code>](#refund-reason-reference-type)<Bullet />[<code>ID!</code>](/api-reference/miscellaneous/scalars/id.mdx) \{#refund-reason-reference-type\}
