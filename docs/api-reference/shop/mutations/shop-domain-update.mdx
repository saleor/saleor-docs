...
#### [<code style={{ fontWeight: 'normal' }}>shopDomainUpdate.<b>input</b></code>](#)<Bullet />[`SiteDomainInput`](../../../api-reference/miscellaneous/inputs/site-domain-input) <Badge class="badge badge--secondary" text="input"/>

> Fields required to update site.

### Type

#### [`ShopDomainUpdate`](../../../api-reference/shop/objects/shop-domain-update) <Badge class="badge badge--secondary" text="object"/>
