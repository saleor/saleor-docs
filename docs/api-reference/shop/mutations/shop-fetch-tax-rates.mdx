...
#### [`ShopFetchTaxRates`](../../../api-reference/shop/objects/shop-fetch-tax-rates) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="shop"/>
