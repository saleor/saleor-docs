...
#### [`input`](#)<Bullet />[`ShopSettingsInput!`](/api-reference/miscellaneous/inputs/shop-settings-input.mdx)

Fields required to update shop settings.

### Type

#### [`ShopSettingsUpdate`](/api-reference/shop/objects/shop-settings-update.mdx)
