...
#### [<code style={{ fontWeight: 'normal' }}>shopAddressUpdate.<b>input</b></code>](#)<Bullet />[`AddressInput`](../../../api-reference/miscellaneous/inputs/address-input) <Badge class="badge badge--secondary" text="input"/>

> Fields required to update shop address.

### Type

#### [`ShopAddressUpdate`](../../../api-reference/shop/objects/shop-address-update) <Badge class="badge badge--secondary" text="object"/>
