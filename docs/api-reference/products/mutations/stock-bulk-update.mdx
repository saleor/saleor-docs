...
#### [`stocks`](#)<Bullet />[`[StockBulkUpdateInput!]!`](/api-reference/products/inputs/stock-bulk-update-input.mdx)

Input list of stocks to update.

### Type

#### [`StockBulkUpdate`](/api-reference/products/objects/stock-bulk-update.mdx)
