...
#### [<code style={{ fontWeight: 'normal' }}>stockBulkUpdate.<b>errorPolicy</b></code>](#)<Bullet />[`ErrorPolicyEnum`](../../../api-reference/miscellaneous/enums/error-policy-enum) <Badge class="secondary" text="enum"/>

> Policies of error handling. DEFAULT: REJECT_EVERYTHING

#### [<code style={{ fontWeight: 'normal' }}>stockBulkUpdate.<b>stocks</b></code>](#)<Bullet />[`[StockBulkUpdateInput!]!`](../../../api-reference/products/inputs/stock-bulk-update-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
