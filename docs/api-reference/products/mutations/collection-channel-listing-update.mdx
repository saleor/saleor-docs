...
#### [<code>input</code>](#input)<Bullet />[<code>CollectionChannelListingUpdateInput!</code>](/api-reference/products/inputs/collection-channel-listing-update-input.mdx) \{#input\}
