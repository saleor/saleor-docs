...
#### [<code style={{ fontWeight: 'normal' }}>productMediaDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a product media to delete.

### Type

#### [`ProductMediaDelete`](../../../api-reference/products/objects/product-media-delete) <Badge class="secondary" text="object"/>
