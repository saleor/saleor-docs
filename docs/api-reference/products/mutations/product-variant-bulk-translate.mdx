...
#### [`translations`](#)<Bullet />[`[ProductVariantBulkTranslateInput!]!`](/api-reference/products/inputs/product-variant-bulk-translate-input.mdx)

List of product variant translations.

### Type

#### [`ProductVariantBulkTranslate`](/api-reference/products/objects/product-variant-bulk-translate.mdx)
