...
#### [<code style={{ fontWeight: 'normal' }}>categoryDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a category to delete.

### Type

#### [`CategoryDelete`](../../../api-reference/products/objects/category-delete) <Badge class="secondary" text="object"/>
