...
#### [`translations`](#)<Bullet />[`[ProductBulkTranslateInput!]!`](/api-reference/products/inputs/product-bulk-translate-input.mdx)

List of product translations.

### Type

#### [`ProductBulkTranslate`](/api-reference/products/objects/product-bulk-translate.mdx)
