...
#### [<code>operations</code>](#operations)<Bullet />[<code>[ProductAttributeAssignInput!]!</code>](/api-reference/products/inputs/product-attribute-assign-input.mdx) \{#operations\}
