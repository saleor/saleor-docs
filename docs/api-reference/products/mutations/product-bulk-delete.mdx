...
#### [<code style={{ fontWeight: 'normal' }}>productBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of product IDs to delete.

### Type

#### [`ProductBulkDelete`](../../../api-reference/products/objects/product-bulk-delete) <Badge class="secondary" text="object"/>
