...
#### [<code style={{ fontWeight: 'normal' }}>collectionDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a collection to delete.

### Type

#### [`CollectionDelete`](../../../api-reference/products/objects/collection-delete) <Badge class="secondary" text="object"/>
