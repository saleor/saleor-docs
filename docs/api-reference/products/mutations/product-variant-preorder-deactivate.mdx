...
#### [<code style={{ fontWeight: 'normal' }}>productVariantPreorderDeactivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> ID of a variant which preorder should be deactivated.

### Type

#### [`ProductVariantPreorderDeactivate`](../../../api-reference/products/objects/product-variant-preorder-deactivate) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="products"/>
