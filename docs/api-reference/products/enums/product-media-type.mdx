...
#### [<code>IMAGE</code>](#image) \{#image\}

#### [<code>VIDEO</code>](#video) \{#video\}

### Member Of

[`ProductMedia`](/api-reference/products/objects/product-media.mdx) <Badge class="badge badge--secondary badge--relation" text="object"/>
