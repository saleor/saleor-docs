...
#### [<code>HIDDEN</code>](#hidden) \{#hidden\}

### Member Of

[`CollectionFilterInput`](/api-reference/products/inputs/collection-filter-input.mdx) <Badge class="badge badge--secondary badge--relation" text="input"/>
