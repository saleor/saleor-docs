...
[`collectionReorderProducts`](/api-reference/products/mutations/collection-reorder-products.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
