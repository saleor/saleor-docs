...
[`unassignWarehouseShippingZone`](/api-reference/products/mutations/unassign-warehouse-shipping-zone.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
