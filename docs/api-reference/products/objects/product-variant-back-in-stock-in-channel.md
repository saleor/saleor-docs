...
[`productVariantBackInStockInChannel`](/api-reference/products/subscriptions/product-variant-back-in-stock-in-channel) <mark class="gqlmd-mdx-badge">subscription</mark>
