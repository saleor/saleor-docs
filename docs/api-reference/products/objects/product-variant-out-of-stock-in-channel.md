...
```graphql
type ProductVariantOutOfStockInChannel implements Event {
  issuedAt: DateTime
  version: String
...
[`productVariantOutOfStockInChannel`](/api-reference/products/subscriptions/product-variant-out-of-stock-in-channel) <mark class="gqlmd-mdx-badge">subscription</mark>
