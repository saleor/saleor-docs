...
##### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">CollectionMetadataUpdated.collection</code>.<code class="gqlmd-mdx-entity-name">channel</code></span>](#collection-metadata-updated-collection-channel)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">String</code></span>](/api-reference/miscellaneous/scalars/string) \{#collection-metadata-updated-collection-channel\}
