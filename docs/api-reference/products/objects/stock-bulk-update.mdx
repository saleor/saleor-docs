...
#### [`results`](#)<Bullet />[`[StockBulkResult!]!`](/api-reference/products/objects/stock-bulk-result.mdx)

List of the updated stocks.

#### [`errors`](#)<Bullet />[`[StockBulkUpdateError!]!`](/api-reference/products/objects/stock-bulk-update-error.mdx)
