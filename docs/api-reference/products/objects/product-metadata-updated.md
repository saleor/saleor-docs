...
##### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">ProductMetadataUpdated.product</code>.<code class="gqlmd-mdx-entity-name">channel</code></span>](#product-metadata-updated-product-channel)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">String</code></span>](/api-reference/miscellaneous/scalars/string) \{#product-metadata-updated-product-channel\}
