...
##### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">ProductVariantStockUpdated.productVariant</code>.<code class="gqlmd-mdx-entity-name">channel</code></span>](#product-variant-stock-updated-product-variant-channel)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">String</code></span>](/api-reference/miscellaneous/scalars/string) \{#product-variant-stock-updated-product-variant-channel\}
