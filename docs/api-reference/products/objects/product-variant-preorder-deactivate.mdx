...
[`productVariantPreorderDeactivate`](/api-reference/deprecated/products/mutations/product-variant-preorder-deactivate.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
