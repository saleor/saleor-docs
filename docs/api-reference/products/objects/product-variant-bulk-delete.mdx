...
[`productVariantBulkDelete`](/api-reference/products/mutations/product-variant-bulk-delete.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
