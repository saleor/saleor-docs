...
##### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">ProductVariantCreated.productVariant</code>.<code class="gqlmd-mdx-entity-name">channel</code></span>](#product-variant-created-product-variant-channel)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">String</code></span>](/api-reference/miscellaneous/scalars/string) \{#product-variant-created-product-variant-channel\}
