...
#### [<code>results</code>](#results)<Bullet />[<code>[ProductVariantBulkTranslateResult!]!</code>](/api-reference/products/objects/product-variant-bulk-translate-result.mdx) \{#results\}
