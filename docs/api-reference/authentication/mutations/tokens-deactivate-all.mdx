...
#### [`DeactivateAllUserTokens`](../../../api-reference/authentication/objects/deactivate-all-user-tokens) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="authentication"/>
