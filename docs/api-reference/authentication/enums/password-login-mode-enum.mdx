...
[`Shop`](/api-reference/miscellaneous/objects/shop.mdx) <Badge class="badge badge--secondary" text="object"/><Bullet />[`ShopSettingsInput`](/api-reference/miscellaneous/inputs/shop-settings-input.mdx) <Badge class="badge badge--secondary" text="input"/>
