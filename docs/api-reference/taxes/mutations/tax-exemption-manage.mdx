...
#### [<code style={{ fontWeight: 'normal' }}>taxExemptionManage.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/> <Badge class="secondary" text="miscellaneous"/>

> ID of the Checkout or Order object.

#### [<code style={{ fontWeight: 'normal' }}>taxExemptionManage.<b>taxExemption</b></code>](#)<Bullet />[`Boolean!`](../../../api-reference/miscellaneous/scalars/boolean) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/> <Badge class="secondary" text="miscellaneous"/>

> Determines if a taxes should be exempt.

### Type

#### [`TaxExemptionManage`](../../../api-reference/taxes/objects/tax-exemption-manage) <Badge class="secondary" text="object"/> <Badge class="secondary" text="taxes"/>
