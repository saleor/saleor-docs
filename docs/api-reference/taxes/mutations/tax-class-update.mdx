...
#### [<code>input</code>](#)<Bullet />[<code>TaxClassUpdateInput!</code>](/api-reference/taxes/inputs/tax-class-update-input.mdx)

Fields required to update a tax class.

### Type

#### [<code>TaxClassUpdate</code>](/api-reference/taxes/objects/tax-class-update.mdx)
