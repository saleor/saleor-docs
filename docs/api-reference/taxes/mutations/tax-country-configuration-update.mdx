...
#### [<code>updateTaxClassRates</code>](#update-tax-class-rates)<Bullet />[<code>[TaxClassRateInput!]!</code>](/api-reference/taxes/inputs/tax-class-rate-input.mdx) \{#update-tax-class-rates\}
