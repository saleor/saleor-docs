...
#### [`updateTaxClassRates`](#)<Bullet />[`[TaxClassRateInput!]!`](/api-reference/taxes/inputs/tax-class-rate-input.mdx)
...
#### [`TaxCountryConfigurationUpdate`](/api-reference/taxes/objects/tax-country-configuration-update.mdx)
