...
#### [<code style={{ fontWeight: 'normal' }}>taxClassDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> ID of a tax class to delete.

### Type

#### [`TaxClassDelete`](../../../api-reference/taxes/objects/tax-class-delete) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="taxes"/>
