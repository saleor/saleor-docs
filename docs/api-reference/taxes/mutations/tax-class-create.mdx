...
#### [<code style={{ fontWeight: 'normal' }}>taxClassCreate.<b>input</b></code>](#)<Bullet />[`TaxClassCreateInput!`](../../../api-reference/taxes/inputs/tax-class-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>
