...
#### [<code style={{ fontWeight: 'normal' }}>taxCountryConfigurationDelete.<b>countryCode</b></code>](#)<Bullet />[`CountryCode!`](../../../api-reference/miscellaneous/enums/country-code) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="enum"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> Country in which to update the tax class rates.

### Type

#### [`TaxCountryConfigurationDelete`](../../../api-reference/taxes/objects/tax-country-configuration-delete) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="taxes"/>
