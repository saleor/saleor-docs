...
#### [`taxableObject`](#)<Bullet />[`TaxSourceObject`](/api-reference/miscellaneous/unions/tax-source-object.mdx)

#### [`errors`](#)<Bullet />[`[TaxExemptionManageError!]!`](/api-reference/taxes/objects/tax-exemption-manage-error.mdx)
