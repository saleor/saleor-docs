...
#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>taxableObject</b></code>](#)<Bullet />[`TaxSourceObject`](../../../api-reference/miscellaneous/unions/tax-source-object) <Badge class="badge badge--secondary" text="union"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>errors</b></code>](#)<Bullet />[`[TaxExemptionManageError!]!`](../../../api-reference/taxes/objects/tax-exemption-manage-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="taxes"/>
