...
#### [<code>taxableObject</code>](#taxable-object)<Bullet />[<code>TaxSourceObject</code>](/api-reference/miscellaneous/unions/tax-source-object.mdx) \{#taxable-object\}

#### [<code>errors</code>](#errors)<Bullet />[<code>[TaxExemptionManageError!]!</code>](/api-reference/taxes/objects/tax-exemption-manage-error.mdx) \{#errors\}
