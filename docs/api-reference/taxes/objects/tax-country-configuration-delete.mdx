...
#### [<code>taxCountryConfiguration</code>](#)<Bullet />[<code>TaxCountryConfiguration</code>](/api-reference/taxes/objects/tax-country-configuration.mdx)

Updated tax class rates grouped by a country.

#### [<code>errors</code>](#)<Bullet />[<code>[TaxCountryConfigurationDeleteError!]!</code>](/api-reference/taxes/objects/tax-country-configuration-delete-error.mdx)
