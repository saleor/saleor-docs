...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">TaxConfigurationUpdateError</code>.<code class="gqlmd-mdx-entity-name">code</code></span>](#code)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">TaxConfigurationUpdateErrorCode!</code></span>](/api-reference/taxes/enums/tax-configuration-update-error-code) \{#code\}
...
[`TaxConfigurationUpdate`](/api-reference/taxes/objects/tax-configuration-update) <mark class="gqlmd-mdx-badge">object</mark>
