...
#### [<code style={{ fontWeight: 'normal' }}>TaxConfigurationUpdate.<b>errors</b></code>](#)<Bullet />[`[TaxConfigurationUpdateError!]!`](../../../api-reference/taxes/objects/tax-configuration-update-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TaxConfigurationUpdate.<b>taxConfiguration</b></code>](#)<Bullet />[`TaxConfiguration`](../../../api-reference/taxes/objects/tax-configuration) <Badge class="secondary" text="object"/>
