...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">TaxClassUpdateError</code>.<code class="gqlmd-mdx-entity-name">code</code></span>](#code)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">TaxClassUpdateErrorCode!</code></span>](/api-reference/taxes/enums/tax-class-update-error-code) \{#code\}
...
[`TaxClassUpdate`](/api-reference/taxes/objects/tax-class-update) <mark class="gqlmd-mdx-badge">object</mark>
