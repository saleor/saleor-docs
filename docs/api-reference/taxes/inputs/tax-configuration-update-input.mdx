...
#### [`updateCountriesConfiguration`](#)<Bullet />[`[TaxConfigurationPerCountryInput!]`](/api-reference/taxes/inputs/tax-configuration-per-country-input.mdx)

List of tax country configurations to create or update (identified by a country code).

#### [`removeCountriesConfiguration`](#)<Bullet />[`[CountryCode!]`](/api-reference/miscellaneous/enums/country-code.mdx)
