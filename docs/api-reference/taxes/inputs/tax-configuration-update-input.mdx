...
#### [<code>updateCountriesConfiguration</code>](#update-countries-configuration)<Bullet />[<code>[TaxConfigurationPerCountryInput!]</code>](/api-reference/taxes/inputs/tax-configuration-per-country-input.mdx) \{#update-countries-configuration\}

List of tax country configurations to create or update (identified by a country code).

#### [<code>removeCountriesConfiguration</code>](#remove-countries-configuration)<Bullet />[<code>[CountryCode!]</code>](/api-reference/miscellaneous/enums/country-code.mdx) \{#remove-countries-configuration\}
