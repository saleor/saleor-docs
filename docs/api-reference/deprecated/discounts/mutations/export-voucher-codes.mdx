...
#### [`input`](#)<Bullet />[`ExportVoucherCodesInput!`](/api-reference/discounts/inputs/export-voucher-codes-input.mdx)

Fields required to export voucher codes.

### Type

#### [`ExportVoucherCodes`](/api-reference/discounts/objects/export-voucher-codes.mdx)
