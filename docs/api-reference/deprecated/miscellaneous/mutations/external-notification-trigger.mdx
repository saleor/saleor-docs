...
#### [<code>input</code>](#input)<Bullet />[<code>ExternalNotificationTriggerInput!</code>](/api-reference/miscellaneous/inputs/external-notification-trigger-input.mdx) \{#input\}
