...
#### [`input`](#)<Bullet />[`ExportGiftCardsInput!`](/api-reference/gift-cards/inputs/export-gift-cards-input.mdx)

Fields required to export gift cards data.

### Type

#### [`ExportGiftCards`](/api-reference/gift-cards/objects/export-gift-cards.mdx)
