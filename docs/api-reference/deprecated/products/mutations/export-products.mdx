...
#### [`input`](#)<Bullet />[`ExportProductsInput!`](/api-reference/products/inputs/export-products-input.mdx)

Fields required to export product data.

### Type

#### [`ExportProducts`](/api-reference/products/objects/export-products.mdx)
