...
#### [`input`](#)<Bullet />[`PromotionRuleCreateInput!`](/api-reference/miscellaneous/inputs/promotion-rule-create-input.mdx)

Fields required to create a promotion rule.

### Type

#### [`PromotionRuleCreate`](/api-reference/discounts/objects/promotion-rule-create.mdx)
