...
#### [<code style={{ fontWeight: 'normal' }}>promotionRuleCreate.<b>input</b></code>](#)<Bullet />[`PromotionRuleCreateInput!`](../../../api-reference/miscellaneous/inputs/promotion-rule-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>
