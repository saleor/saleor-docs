...
#### [`input`](#)<Bullet />[`PromotionUpdateInput!`](/api-reference/miscellaneous/inputs/promotion-update-input.mdx)

Fields required to update a promotion.

### Type

#### [`PromotionUpdate`](/api-reference/discounts/objects/promotion-update.mdx)
