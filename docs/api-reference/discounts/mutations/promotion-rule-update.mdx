...
#### [`input`](#)<Bullet />[`PromotionRuleUpdateInput!`](/api-reference/miscellaneous/inputs/promotion-rule-update-input.mdx)

Fields required to create a promotion rule.

### Type

#### [`PromotionRuleUpdate`](/api-reference/discounts/objects/promotion-rule-update.mdx)
