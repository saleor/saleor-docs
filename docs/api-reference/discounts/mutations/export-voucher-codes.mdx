...
#### [<code style={{ fontWeight: 'normal' }}>exportVoucherCodes.<b>input</b></code>](#)<Bullet />[`ExportVoucherCodesInput!`](../../../api-reference/discounts/inputs/export-voucher-codes-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to export voucher codes.

### Type

#### [`ExportVoucherCodes`](../../../api-reference/discounts/objects/export-voucher-codes) <Badge class="badge badge--secondary" text="object"/>
