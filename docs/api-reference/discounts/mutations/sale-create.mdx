...
#### [<code style={{ fontWeight: 'normal' }}>saleCreate.<b>input</b></code>](#)<Bullet />[`SaleInput!`](../../../api-reference/discounts/inputs/sale-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="discounts"/>

> Fields required to create a sale.

### Type

#### [`SaleCreate`](../../../api-reference/discounts/objects/sale-create) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="discounts"/>
