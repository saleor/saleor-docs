...
#### [`input`](#)<Bullet />[`PromotionCreateInput!`](/api-reference/discounts/inputs/promotion-create-input.mdx)

Fields requires to create a promotion.

### Type

#### [`PromotionCreate`](/api-reference/discounts/objects/promotion-create.mdx)
