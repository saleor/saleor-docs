...
#### [<code style={{ fontWeight: 'normal' }}>voucherBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of voucher IDs to delete.

### Type

#### [`VoucherBulkDelete`](../../../api-reference/discounts/objects/voucher-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
