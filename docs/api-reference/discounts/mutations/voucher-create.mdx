...
#### [<code style={{ fontWeight: 'normal' }}>voucherCreate.<b>input</b></code>](#)<Bullet />[`VoucherInput!`](../../../api-reference/discounts/inputs/voucher-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to create a voucher.

### Type

#### [`VoucherCreate`](../../../api-reference/discounts/objects/voucher-create) <Badge class="secondary" text="object"/>
