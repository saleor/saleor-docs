...
##### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">VoucherMetadataUpdated.voucher</code>.<code class="gqlmd-mdx-entity-name">channel</code></span>](#voucher-metadata-updated-voucher-channel)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">String</code></span>](/api-reference/miscellaneous/scalars/string) \{#voucher-metadata-updated-voucher-channel\}
