...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>checkRequiredFields</b></code>](#)<Bullet />[`Boolean`](../../api-reference/scalars/boolean) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>checkFieldsFormat</b></code>](#)<Bullet />[`Boolean`](../../api-reference/scalars/boolean) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>enableFieldsNormalization</b></code>](#)<Bullet />[`Boolean`](../../api-reference/scalars/boolean) <Badge class="secondary" text="scalar"/>

> Determines if Saleor should apply normalization on address fields. Example: converting city field to uppercase letters.

### Member of

[`checkoutBillingAddressUpdate`](../../api-reference/mutations/checkout-billing-address-update) <Badge class="secondary" text="mutation"/><Bullet />[`checkoutShippingAddressUpdate`](../../api-reference/mutations/checkout-shipping-address-update) <Badge class="secondary" text="mutation"/><Bullet />[`CheckoutValidationRules`](../../api-reference/inputs/checkout-validation-rules) <Badge class="secondary" text="input"/>
