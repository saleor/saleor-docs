---
api_reference: true
id: customer-type-sort-field
title: CustomerTypeSortField
---
...
[`CustomerTypeSortingInput`](/api-reference/users/inputs/customer-type-sorting-input.mdx) <Badge class="badge badge--secondary badge--relation" text="input"/>
