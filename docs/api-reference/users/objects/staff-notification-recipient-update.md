...
[`staffNotificationRecipientUpdate`](/api-reference/users/mutations/staff-notification-recipient-update) <mark class="gqlmd-mdx-badge">mutation</mark>
