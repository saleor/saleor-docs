...
[`staffNotificationRecipientDelete`](/api-reference/users/mutations/staff-notification-recipient-delete) <mark class="gqlmd-mdx-badge">mutation</mark>
