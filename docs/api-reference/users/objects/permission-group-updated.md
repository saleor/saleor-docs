...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">PermissionGroupUpdated</code>.<code class="gqlmd-mdx-entity-name">permissionGroup</code></span>](#permission-group)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">Group</code></span>](/api-reference/users/objects/group) \{#permission-group\}
