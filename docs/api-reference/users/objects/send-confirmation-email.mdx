...
#### [<code style={{ fontWeight: 'normal' }}>SendConfirmationEmail.<b>errors</b></code>](#)<Bullet />[`[SendConfirmationEmailError!]!`](../../../api-reference/users/objects/send-confirmation-email-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>
