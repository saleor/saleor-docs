...
#### [<code style={{ fontWeight: 'normal' }}>customerCreate.<b>input</b></code>](#)<Bullet />[`UserCreateInput!`](../../../api-reference/users/inputs/user-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="users"/>

> Fields required to create a customer.

### Type

#### [`CustomerCreate`](../../../api-reference/users/objects/customer-create) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>
