...
#### [<code style={{ fontWeight: 'normal' }}>staffBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of user IDs to delete.

### Type

#### [`StaffBulkDelete`](../../../api-reference/users/objects/staff-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
