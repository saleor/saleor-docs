...
#### [`input`](#)<Bullet />[`AccountRegisterInput!`](/api-reference/users/inputs/account-register-input.mdx)

Fields required to create a user.

### Type

#### [`AccountRegister`](/api-reference/users/objects/account-register.mdx)
