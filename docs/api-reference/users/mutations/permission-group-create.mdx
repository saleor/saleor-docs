...
#### [<code style={{ fontWeight: 'normal' }}>permissionGroupCreate.<b>input</b></code>](#)<Bullet />[`PermissionGroupCreateInput!`](../../../api-reference/users/inputs/permission-group-create-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
