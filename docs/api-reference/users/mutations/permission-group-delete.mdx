...
#### [<code style={{ fontWeight: 'normal' }}>permissionGroupDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the group to delete.

### Type

#### [`PermissionGroupDelete`](../../../api-reference/users/objects/permission-group-delete) <Badge class="secondary" text="object"/>
