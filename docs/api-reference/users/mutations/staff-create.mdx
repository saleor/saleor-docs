...
#### [<code style={{ fontWeight: 'normal' }}>staffCreate.<b>input</b></code>](#)<Bullet />[`StaffCreateInput!`](../../../api-reference/users/inputs/staff-create-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to create a staff user.

### Type

#### [`StaffCreate`](../../../api-reference/users/objects/staff-create) <Badge class="secondary" text="object"/>
