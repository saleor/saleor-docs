...
#### [<code style={{ fontWeight: 'normal' }}>staffCreate.<b>input</b></code>](#)<Bullet />[`StaffCreateInput!`](../../../api-reference/users/inputs/staff-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="users"/>

> Fields required to create a staff user.

### Type

#### [`StaffCreate`](../../../api-reference/users/objects/staff-create) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>
