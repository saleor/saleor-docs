...
#### [<code style={{ fontWeight: 'normal' }}>customerBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of user IDs to delete.

### Type

#### [`CustomerBulkDelete`](../../../api-reference/users/objects/customer-bulk-delete) <Badge class="secondary" text="object"/>
