...
#### [<code>input</code>](#)<Bullet />[<code>StaffUpdateInput!</code>](/api-reference/users/inputs/staff-update-input.mdx)

Fields required to update a staff user.

### Type

#### [<code>StaffUpdate</code>](/api-reference/users/objects/staff-update.mdx)
