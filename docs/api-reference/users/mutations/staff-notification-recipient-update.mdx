...
#### [<code>input</code>](#)<Bullet />[<code>StaffNotificationRecipientInput!</code>](/api-reference/miscellaneous/inputs/staff-notification-recipient-input.mdx)

Fields required to update a staff notification recipient.

### Type

#### [<code>StaffNotificationRecipientUpdate</code>](/api-reference/users/objects/staff-notification-recipient-update.mdx)
