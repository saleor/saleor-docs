...
#### [`UserAvatarDelete`](../../../api-reference/users/objects/user-avatar-delete) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>
