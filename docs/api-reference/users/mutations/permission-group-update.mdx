...
#### [<code style={{ fontWeight: 'normal' }}>permissionGroupUpdate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the group to update.

#### [<code style={{ fontWeight: 'normal' }}>permissionGroupUpdate.<b>input</b></code>](#)<Bullet />[`PermissionGroupUpdateInput!`](../../../api-reference/users/inputs/permission-group-update-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
