...
#### [<code>paymentGateways</code>](#payment-gateways)<Bullet />[<code>[PaymentGatewayToInitialize!]</code>](/api-reference/payments/inputs/payment-gateway-to-initialize.mdx) \{#payment-gateways\}
