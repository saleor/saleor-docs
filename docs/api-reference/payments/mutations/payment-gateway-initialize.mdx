...
#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>amount</b></code>](#)<Bullet />[`PositiveDecimal`](../../../api-reference/miscellaneous/scalars/positive-decimal) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> The ID of the checkout or order.

#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>paymentGateways</b></code>](#)<Bullet />[`[PaymentGatewayToInitialize!]`](../../../api-reference/payments/inputs/payment-gateway-to-initialize) <Badge class="secondary" text="list"/> <Badge class="secondary" text="input"/>
