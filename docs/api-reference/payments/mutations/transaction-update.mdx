...
#### [`transaction`](#)<Bullet />[`TransactionUpdateInput`](/api-reference/payments/inputs/transaction-update-input.mdx)
...
#### [`TransactionUpdate`](/api-reference/payments/objects/transaction-update.mdx)
