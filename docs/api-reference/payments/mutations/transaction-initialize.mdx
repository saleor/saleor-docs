...
#### [<code>action</code>](#action)<Bullet />[<code>TransactionFlowStrategyEnum</code>](/api-reference/payments/enums/transaction-flow-strategy-enum.mdx) \{#action\}
...
#### [<code>paymentGateway</code>](#payment-gateway)<Bullet />[<code>PaymentGatewayToInitialize!</code>](/api-reference/payments/inputs/payment-gateway-to-initialize.mdx) \{#payment-gateway\}
