...
#### [<code>where</code>](#where)<Bullet />[<code>TransactionWhereInput</code>](/api-reference/payments/inputs/transaction-where-input.mdx) \{#where\}

Where filtering options for transactions.

#### [<code>sortBy</code>](#sort-by)<Bullet />[<code>TransactionSortingInput</code>](/api-reference/payments/inputs/transaction-sorting-input.mdx) \{#sort-by\}
