...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-parent">PaymentCapture</code>.<code class="gqlmd-mdx-entity-name">payment</code></span>](#payment)<span class="gqlmd-mdx-bullet">&nbsp;●&nbsp;</span>[<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">Payment</code></span>](/api-reference/payments/objects/payment) \{#payment\}
...
[`paymentCapture`](/api-reference/deprecated/payments/mutations/payment-capture) <mark class="gqlmd-mdx-badge">mutation</mark>
