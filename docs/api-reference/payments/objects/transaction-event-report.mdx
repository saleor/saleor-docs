...
#### [`alreadyProcessed`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`errors`](#)<Bullet />[`[TransactionEventReportError!]!`](/api-reference/payments/objects/transaction-event-report-error.mdx)
