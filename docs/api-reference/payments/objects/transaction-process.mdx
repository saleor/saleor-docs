...
#### [<code style={{ fontWeight: 'normal' }}>TransactionProcess.<b>errors</b></code>](#)<Bullet />[`[TransactionProcessError!]!`](../../../api-reference/miscellaneous/objects/transaction-process-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>
