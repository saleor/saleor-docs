...
#### [<code style={{ fontWeight: 'normal' }}>TransactionUpdate.<b>transaction</b></code>](#)<Bullet />[`TransactionItem`](../../../api-reference/payments/objects/transaction-item) <Badge class="badge badge--secondary" text="object"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TransactionUpdate.<b>errors</b></code>](#)<Bullet />[`[TransactionUpdateError!]!`](../../../api-reference/payments/objects/transaction-update-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/>
