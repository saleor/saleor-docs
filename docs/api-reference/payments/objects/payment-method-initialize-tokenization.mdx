...
#### [<code>errors</code>](#errors)<Bullet />[<code>[PaymentMethodInitializeTokenizationError!]!</code>](/api-reference/payments/objects/payment-method-initialize-tokenization-error.mdx) \{#errors\}
