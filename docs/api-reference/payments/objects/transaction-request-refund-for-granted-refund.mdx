...
#### [<code>errors</code>](#)<Bullet />[<code>[TransactionRequestRefundForGrantedRefundError!]!</code>](/api-reference/payments/objects/transaction-request-refund-for-granted-refund-error.mdx)
