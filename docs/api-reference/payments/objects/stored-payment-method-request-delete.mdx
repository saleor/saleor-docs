...
#### [`result`](#)<Bullet />[`StoredPaymentMethodRequestDeleteResult!`](/api-reference/payments/enums/stored-payment-method-request-delete-result.mdx)

The result of deleting a stored payment method.

#### [`errors`](#)<Bullet />[`[PaymentMethodRequestDeleteError!]!`](/api-reference/payments/objects/payment-method-request-delete-error.mdx)
