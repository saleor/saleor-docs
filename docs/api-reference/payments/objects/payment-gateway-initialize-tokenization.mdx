...
#### [<code>result</code>](#)<Bullet />[<code>PaymentGatewayInitializeTokenizationResult!</code>](/api-reference/payments/enums/payment-gateway-initialize-tokenization-result.mdx)
...
#### [<code>errors</code>](#)<Bullet />[<code>[PaymentGatewayInitializeTokenizationError!]!</code>](/api-reference/payments/objects/payment-gateway-initialize-tokenization-error.mdx)
