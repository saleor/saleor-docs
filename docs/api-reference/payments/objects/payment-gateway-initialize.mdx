...
#### [<code>gatewayConfigs</code>](#)<Bullet />[<code>[PaymentGatewayConfig!]</code>](/api-reference/payments/objects/payment-gateway-config.mdx)

List of payment gateway configurations.

#### [<code>errors</code>](#)<Bullet />[<code>[PaymentGatewayInitializeError!]!</code>](/api-reference/payments/objects/payment-gateway-initialize-error.mdx)
