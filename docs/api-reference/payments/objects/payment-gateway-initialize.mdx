...
#### [`gatewayConfigs`](#)<Bullet />[`[PaymentGatewayConfig!]`](/api-reference/payments/objects/payment-gateway-config.mdx)

List of payment gateway configurations.

#### [`errors`](#)<Bullet />[`[PaymentGatewayInitializeError!]!`](/api-reference/payments/objects/payment-gateway-initialize-error.mdx)
