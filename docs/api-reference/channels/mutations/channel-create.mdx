...
#### [<code>input</code>](#input)<Bullet />[<code>ChannelCreateInput!</code>](/api-reference/channels/inputs/channel-create-input.mdx) \{#input\}

Fields required to create channel.

### Type

#### [<code>ChannelCreate</code>](/api-reference/channels/objects/channel-create.mdx)
