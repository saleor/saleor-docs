...
#### [<code>input</code>](#)<Bullet />[<code>ChannelDeleteInput</code>](/api-reference/channels/inputs/channel-delete-input.mdx)

Fields required to delete a channel.

### Type

#### [<code>ChannelDelete</code>](/api-reference/channels/objects/channel-delete.mdx)
