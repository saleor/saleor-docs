...
#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>taxableObject</b></code>](#)<Bullet />[`TaxSourceObject`](../../api-reference/unions/tax-source-object) <Badge class="secondary" text="union"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>errors</b></code>](#)<Bullet />[`[TaxExemptionManageError!]!`](../../api-reference/objects/tax-exemption-manage-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>

>

### Returned by

[`taxExemptionManage`](../../api-reference/mutations/tax-exemption-manage) <Badge class="secondary" text="mutation"/>
