...
#### [<code>input</code>](#input)<Bullet />[<code>MenuCreateInput!</code>](/api-reference/miscellaneous/inputs/menu-create-input.mdx) \{#input\}

Fields required to create a menu.

### Type

#### [<code>MenuCreate</code>](/api-reference/menu/objects/menu-create.mdx)
