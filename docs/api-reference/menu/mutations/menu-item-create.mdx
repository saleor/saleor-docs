...
#### [`input`](#)<Bullet />[`MenuItemCreateInput!`](/api-reference/miscellaneous/inputs/menu-item-create-input.mdx)

Fields required to update a menu item. Only one of `url`, `category`, `page`, `collection` is allowed per item.

### Type

#### [`MenuItemCreate`](/api-reference/menu/objects/menu-item-create.mdx)
