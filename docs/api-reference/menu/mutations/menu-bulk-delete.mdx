...
#### [<code style={{ fontWeight: 'normal' }}>menuBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of menu IDs to delete.

### Type

#### [`MenuBulkDelete`](../../../api-reference/menu/objects/menu-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
