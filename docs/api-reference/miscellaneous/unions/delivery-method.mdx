...
#### [<code style={{ fontWeight: 'normal' }}>DeliveryMethod.<b>Warehouse</b></code>](../../../api-reference/products/objects/warehouse) <Badge class="secondary" text="object"/>

> Represents warehouse.

#### [<code style={{ fontWeight: 'normal' }}>DeliveryMethod.<b>ShippingMethod</b></code>](../../../api-reference/shipping/objects/shipping-method) <Badge class="secondary" text="object"/>
