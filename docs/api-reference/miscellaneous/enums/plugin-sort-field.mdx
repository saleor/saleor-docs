...
#### [<code>IS_ACTIVE</code>](#is-active) \{#is-active\}

### Member Of

[`PluginSortingInput`](/api-reference/miscellaneous/inputs/plugin-sorting-input.mdx) <Badge class="badge badge--secondary badge--relation" text="input"/>
