...
#### [<code>type</code>](#type)<Bullet />[<code>PaymentMethodTypeEnumFilterInput</code>](/api-reference/miscellaneous/inputs/payment-method-type-enum-filter-input.mdx) \{#type\}

Filter by payment method type used to pay for the order.

#### [<code>card</code>](#card)<Bullet />[<code>PaymentMethodDetailsCardFilterInput</code>](/api-reference/miscellaneous/inputs/payment-method-details-card-filter-input.mdx) \{#card\}
