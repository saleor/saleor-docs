...
#### [<code style={{ fontWeight: 'normal' }}>CountryFilterInput.<b>attachedToShippingZones</b></code>](#)<Bullet />[`Boolean`](../../../api-reference/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>
