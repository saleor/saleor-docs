...
#### [<code>eq</code>](#)<Bullet />[<code>PaymentMethodTypeEnum</code>](/api-reference/payments/enums/payment-method-type-enum.mdx)

The value equal to.

#### [<code>oneOf</code>](#)<Bullet />[<code>[PaymentMethodTypeEnum!]</code>](/api-reference/payments/enums/payment-method-type-enum.mdx)
