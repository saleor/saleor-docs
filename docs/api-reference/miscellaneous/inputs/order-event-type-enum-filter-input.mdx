...
#### [<code>eq</code>](#)<Bullet />[<code>OrderEventsEnum</code>](/api-reference/orders/enums/order-events-enum.mdx)

The value equal to.

#### [<code>oneOf</code>](#)<Bullet />[<code>[OrderEventsEnum!]</code>](/api-reference/orders/enums/order-events-enum.mdx)
