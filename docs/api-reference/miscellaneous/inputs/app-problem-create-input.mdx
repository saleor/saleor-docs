...
#### [`criticalThreshold`](#)<Bullet />[`PositiveInt`](/api-reference/miscellaneous/scalars/positive-int.mdx)
...
#### [`aggregationPeriod`](#)<Bullet />[`Minute`](/api-reference/miscellaneous/scalars/minute.mdx)
