...
#### [`input`](#)<Bullet />[`[MetadataInput!]!`](/api-reference/miscellaneous/inputs/metadata-input.mdx)

Fields required to update the object's metadata.

### Type

#### [`UpdatePrivateMetadata`](/api-reference/miscellaneous/objects/update-private-metadata.mdx)
