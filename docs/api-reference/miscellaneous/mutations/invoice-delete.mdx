...
#### [<code style={{ fontWeight: 'normal' }}>invoiceDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of an invoice to delete.

### Type

#### [`InvoiceDelete`](../../../api-reference/miscellaneous/objects/invoice-delete) <Badge class="secondary" text="object"/>
