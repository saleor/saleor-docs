...
#### [<code style={{ fontWeight: 'normal' }}>shopSettingsUpdate.<b>input</b></code>](#)<Bullet />[`ShopSettingsInput!`](../../../api-reference/miscellaneous/inputs/shop-settings-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to update shop settings.

### Type

#### [`ShopSettingsUpdate`](../../../api-reference/miscellaneous/objects/shop-settings-update) <Badge class="secondary" text="object"/>
