...
#### [<code style={{ fontWeight: 'normal' }}>menuItemDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a menu item to delete.

### Type

#### [`MenuItemDelete`](../../../api-reference/miscellaneous/objects/menu-item-delete) <Badge class="secondary" text="object"/>
