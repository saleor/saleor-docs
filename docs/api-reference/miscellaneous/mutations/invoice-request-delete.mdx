...
#### [<code style={{ fontWeight: 'normal' }}>invoiceRequestDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of an invoice to request the deletion.

### Type

#### [`InvoiceRequestDelete`](../../../api-reference/miscellaneous/objects/invoice-request-delete) <Badge class="secondary" text="object"/>
