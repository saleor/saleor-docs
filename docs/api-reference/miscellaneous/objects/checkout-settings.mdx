...
#### [<code>automaticCompletionDelay</code>](#)<Bullet />[<code>Minute</code>](/api-reference/miscellaneous/scalars/minute.mdx)
...
#### [<code>automaticCompletionCutOffDate</code>](#)<Bullet />[<code>DateTime</code>](/api-reference/miscellaneous/scalars/date-time.mdx)
