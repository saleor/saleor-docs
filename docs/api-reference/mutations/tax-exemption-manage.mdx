...
#### [<code style={{ fontWeight: 'normal' }}>taxExemptionManage.<b>id</b></code>](#)<Bullet />[`ID!`](../../api-reference/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the Checkout or Order object.

#### [<code style={{ fontWeight: 'normal' }}>taxExemptionManage.<b>taxExemption</b></code>](#)<Bullet />[`Boolean!`](../../api-reference/scalars/boolean) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
