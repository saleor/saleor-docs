...
#### [<code style={{ fontWeight: 'normal' }}>menuBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../api-reference/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of menu IDs to delete.

### Type

#### [`MenuBulkDelete`](../../api-reference/objects/menu-bulk-delete) <Badge class="secondary" text="object"/>
