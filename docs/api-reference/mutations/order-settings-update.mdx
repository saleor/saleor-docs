...
#### [<code style={{ fontWeight: 'normal' }}>orderSettingsUpdate.<b>input</b></code>](#)<Bullet />[`OrderSettingsUpdateInput!`](../../api-reference/inputs/order-settings-update-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
