...
#### [<code style={{ fontWeight: 'normal' }}>staffBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../api-reference/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of user IDs to delete.

### Type

#### [`StaffBulkDelete`](../../api-reference/objects/staff-bulk-delete) <Badge class="secondary" text="object"/>
