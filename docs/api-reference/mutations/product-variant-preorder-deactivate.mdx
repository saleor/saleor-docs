...
#### [<code style={{ fontWeight: 'normal' }}>productVariantPreorderDeactivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../api-reference/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a variant which preorder should be deactivated.

### Type

#### [`ProductVariantPreorderDeactivate`](../../api-reference/objects/product-variant-preorder-deactivate) <Badge class="secondary" text="object"/>
