...
#### [<code style={{ fontWeight: 'normal' }}>giftCardBulkDeactivate.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of gift card IDs to deactivate.

### Type

#### [`GiftCardBulkDeactivate`](../../../api-reference/gift-cards/objects/gift-card-bulk-deactivate) <Badge class="secondary" text="object"/>
