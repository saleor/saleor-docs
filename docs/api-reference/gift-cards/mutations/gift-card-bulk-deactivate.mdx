...
#### [<code style={{ fontWeight: 'normal' }}>giftCardBulkDeactivate.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> List of gift card IDs to deactivate.

### Type

#### [`GiftCardBulkDeactivate`](../../../api-reference/gift-cards/objects/gift-card-bulk-deactivate) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="gift-cards"/>
