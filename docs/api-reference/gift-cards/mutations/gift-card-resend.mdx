...
#### [<code style={{ fontWeight: 'normal' }}>giftCardResend.<b>input</b></code>](#)<Bullet />[`GiftCardResendInput!`](../../../api-reference/gift-cards/inputs/gift-card-resend-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to resend a gift card.

### Type

#### [`GiftCardResend`](../../../api-reference/gift-cards/objects/gift-card-resend) <Badge class="badge badge--secondary" text="object"/>
