...
#### [<code>input</code>](#input)<Bullet />[<code>GiftCardBulkCreateInput!</code>](/api-reference/gift-cards/inputs/gift-card-bulk-create-input.mdx) \{#input\}

Fields required to create gift cards.

### Type

#### [<code>GiftCardBulkCreate</code>](/api-reference/gift-cards/objects/gift-card-bulk-create.mdx)
