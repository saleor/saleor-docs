...
#### [`input`](#)<Bullet />[`GiftCardBulkCreateInput!`](/api-reference/gift-cards/inputs/gift-card-bulk-create-input.mdx)

Fields required to create gift cards.

### Type

#### [`GiftCardBulkCreate`](/api-reference/gift-cards/objects/gift-card-bulk-create.mdx)
