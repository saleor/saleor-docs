...
#### [<code style={{ fontWeight: 'normal' }}>giftCardBulkCreate.<b>input</b></code>](#)<Bullet />[`GiftCardBulkCreateInput!`](../../../api-reference/gift-cards/inputs/gift-card-bulk-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="gift-cards"/>

> Fields required to create gift cards.

### Type

#### [`GiftCardBulkCreate`](../../../api-reference/gift-cards/objects/gift-card-bulk-create) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="gift-cards"/>
