...
#### [<code style={{ fontWeight: 'normal' }}>giftCardDeactivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a gift card to deactivate.

### Type

#### [`GiftCardDeactivate`](../../../api-reference/gift-cards/objects/gift-card-deactivate) <Badge class="secondary" text="object"/>
