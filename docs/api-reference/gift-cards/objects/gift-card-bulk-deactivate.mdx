...
[`giftCardBulkDeactivate`](/api-reference/gift-cards/mutations/gift-card-bulk-deactivate.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
