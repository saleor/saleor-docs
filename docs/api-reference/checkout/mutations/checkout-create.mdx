...
#### [`input`](#)<Bullet />[`CheckoutCreateInput!`](/api-reference/checkout/inputs/checkout-create-input.mdx)

Fields required to create checkout.

### Type

#### [`CheckoutCreate`](/api-reference/checkout/objects/checkout-create.mdx)
