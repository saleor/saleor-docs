...
[`checkoutCustomerNoteUpdate`](/api-reference/checkout/mutations/checkout-customer-note-update.mdx) <Badge class="badge badge--secondary badge--relation" text="mutation"/>
