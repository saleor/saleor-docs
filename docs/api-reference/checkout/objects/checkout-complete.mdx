...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutComplete.<b>order</b></code>](#)<Bullet />[`Order`](../../../api-reference/orders/objects/order) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="orders"/>

> Placed order.

#### [<code style={{ fontWeight: 'normal' }}>CheckoutComplete.<b>confirmationNeeded</b></code>](#)<Bullet />[`Boolean!`](../../../api-reference/miscellaneous/scalars/boolean) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> Set to true if payment needs to be confirmed before checkout is complete.

#### [<code style={{ fontWeight: 'normal' }}>CheckoutComplete.<b>confirmationData</b></code>](#)<Bullet />[`JSONString`](../../../api-reference/miscellaneous/scalars/jsonstring) <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> Confirmation data used to process additional authorization steps.

#### [<code style={{ fontWeight: 'normal' }}>CheckoutComplete.<b>checkoutErrors</b></code>](#)<Bullet />[`[CheckoutError!]!`](../../../api-reference/checkout/objects/checkout-error) <Badge class="badge badge--deprecated badge--secondary" text="deprecated"/> <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="checkout"/>
...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutComplete.<b>errors</b></code>](#)<Bullet />[`[CheckoutError!]!`](../../../api-reference/checkout/objects/checkout-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="checkout"/>
