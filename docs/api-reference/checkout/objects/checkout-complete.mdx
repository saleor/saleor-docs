...
#### [`confirmationNeeded`](#)<Bullet />[`Boolean!`](/api-reference/miscellaneous/scalars/boolean.mdx)

Set to true if payment needs to be confirmed before checkout is complete.

#### [`confirmationData`](#)<Bullet />[`JSONString`](/api-reference/miscellaneous/scalars/jsonstring.mdx)
