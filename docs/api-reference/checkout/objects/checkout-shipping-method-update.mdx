...
[`checkoutShippingMethodUpdate`](/api-reference/deprecated/checkout/mutations/checkout-shipping-method-update.mdx) <Badge class="badge badge--secondary" text="mutation"/>
