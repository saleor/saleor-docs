...
#### [<code>shippingAddress</code>](#shipping-address)<Bullet />[<code>CheckoutAddressValidationRules</code>](/api-reference/checkout/inputs/checkout-address-validation-rules.mdx) \{#shipping-address\}

The validation rules that can be applied to provided shipping address data.

#### [<code>billingAddress</code>](#billing-address)<Bullet />[<code>CheckoutAddressValidationRules</code>](/api-reference/checkout/inputs/checkout-address-validation-rules.mdx) \{#billing-address\}
