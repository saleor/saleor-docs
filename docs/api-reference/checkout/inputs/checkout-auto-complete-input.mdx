...
#### [<code>enabled</code>](#enabled)<Bullet />[<code>Boolean!</code>](/api-reference/miscellaneous/scalars/boolean.mdx) \{#enabled\}
...
#### [<code>delay</code>](#delay)<Bullet />[<code>Minute</code>](/api-reference/miscellaneous/scalars/minute.mdx) \{#delay\}
...
#### [<code>cutOffDate</code>](#cut-off-date)<Bullet />[<code>DateTime</code>](/api-reference/miscellaneous/scalars/date-time.mdx) \{#cut-off-date\}
