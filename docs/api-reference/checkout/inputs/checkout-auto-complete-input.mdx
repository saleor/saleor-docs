...
#### [`enabled`](#)<Bullet />[`Boolean!`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`delay`](#)<Bullet />[`Minute`](/api-reference/miscellaneous/scalars/minute.mdx)
...
#### [`cutOffDate`](#)<Bullet />[`DateTime`](/api-reference/miscellaneous/scalars/date-time.mdx)
