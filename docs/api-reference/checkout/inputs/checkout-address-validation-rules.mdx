...
#### [`checkRequiredFields`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`checkFieldsFormat`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`enableFieldsNormalization`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
