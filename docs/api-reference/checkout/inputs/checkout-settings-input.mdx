...
#### [`automaticCompletion`](#)<Bullet />[`CheckoutAutoCompleteInput`](/api-reference/checkout/inputs/checkout-auto-complete-input.mdx)

Settings for automatic completion of fully paid checkouts.

Added in Saleor 3.22.

#### [`allowLegacyGiftCardUse`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`useLegacyErrorFlow`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
...
#### [`automaticallyCompleteFullyPaidCheckouts`](#)<Bullet />[`Boolean`](/api-reference/miscellaneous/scalars/boolean.mdx)
