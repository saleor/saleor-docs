...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutSettingsInput.<b>useLegacyErrorFlow</b></code>](#)<Bullet />[`Boolean`](../../../api-reference/miscellaneous/scalars/boolean) <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
