...
#### [<code style={{ fontWeight: 'normal' }}>pageBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of page IDs to delete.

### Type

#### [`PageBulkDelete`](../../../api-reference/pages/objects/page-bulk-delete) <Badge class="secondary" text="object"/>
