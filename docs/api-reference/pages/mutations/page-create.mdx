...
#### [<code>input</code>](#input)<Bullet />[<code>PageCreateInput!</code>](/api-reference/pages/inputs/page-create-input.mdx) \{#input\}

Fields required to create a page.

### Type

#### [<code>PageCreate</code>](/api-reference/pages/objects/page-create.mdx)
