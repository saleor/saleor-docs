...
#### [<code style={{ fontWeight: 'normal' }}>pageCreate.<b>input</b></code>](#)<Bullet />[`PageCreateInput!`](../../../api-reference/pages/inputs/page-create-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to create a page.

### Type

#### [`PageCreate`](../../../api-reference/pages/objects/page-create) <Badge class="secondary" text="object"/>
