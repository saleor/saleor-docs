...
#### [<code>input</code>](#input)<Bullet />[<code>PageTypeCreateInput!</code>](/api-reference/pages/inputs/page-type-create-input.mdx) \{#input\}

Fields required to create page type.

### Type

#### [<code>PageTypeCreate</code>](/api-reference/pages/objects/page-type-create.mdx)
