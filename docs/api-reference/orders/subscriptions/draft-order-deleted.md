...
#### [<span class="gqlmd-mdx-entity"><code class="gqlmd-mdx-entity-name">DraftOrderDeleted</code></span>](/api-reference/orders/objects/draft-order-deleted)
