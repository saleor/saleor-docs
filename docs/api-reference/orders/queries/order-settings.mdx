...
#### [`OrderSettings`](../../../api-reference/miscellaneous/objects/order-settings.mdx) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
