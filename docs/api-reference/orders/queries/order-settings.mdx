...
<Badge
  class="warning"
  text="DEPRECATED: This field will be removed in Saleor 4.0. Use the `channel` query to fetch the `orderSettings` field instead."
/>
...
#### [`OrderSettings`](../../../api-reference/miscellaneous/objects/order-settings) <Badge class="secondary" text="object"/>
