...
#### [<code style={{ fontWeight: 'normal' }}>orderCreateFromCheckout.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> ID of a checkout that will be converted to an order.

#### [<code style={{ fontWeight: 'normal' }}>orderCreateFromCheckout.<b>metadata</b></code>](#)<Bullet />[`[MetadataInput!]`](../../../api-reference/miscellaneous/inputs/metadata-input) <Badge class="badge badge--secondary" text="list"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
...
#### [<code style={{ fontWeight: 'normal' }}>orderCreateFromCheckout.<b>privateMetadata</b></code>](#)<Bullet />[`[MetadataInput!]`](../../../api-reference/miscellaneous/inputs/metadata-input) <Badge class="badge badge--secondary" text="list"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="miscellaneous"/>
...
#### [<code style={{ fontWeight: 'normal' }}>orderCreateFromCheckout.<b>removeCheckout</b></code>](#)<Bullet />[`Boolean`](../../../api-reference/miscellaneous/scalars/boolean) <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> Determines if checkout should be removed after creating an order. Default true.

### Type

#### [`OrderCreateFromCheckout`](../../../api-reference/orders/objects/order-create-from-checkout) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="orders"/>
