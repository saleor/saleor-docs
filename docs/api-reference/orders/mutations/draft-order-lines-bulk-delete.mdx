...
#### [<code style={{ fontWeight: 'normal' }}>draftOrderLinesBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of order lines IDs to delete.

### Type

#### [`DraftOrderLinesBulkDelete`](../../../api-reference/orders/objects/draft-order-lines-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
