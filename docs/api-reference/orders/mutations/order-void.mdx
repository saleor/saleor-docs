...
#### [<code style={{ fontWeight: 'normal' }}>orderVoid.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the order to void.

### Type

#### [`OrderVoid`](../../../api-reference/orders/objects/order-void) <Badge class="secondary" text="object"/>
