...
#### [`input`](#)<Bullet />[`OrderUpdateShippingInput!`](/api-reference/orders/inputs/order-update-shipping-input.mdx)

Fields required to change shipping method of the order.

### Type

#### [`OrderUpdateShipping`](/api-reference/orders/objects/order-update-shipping.mdx)
