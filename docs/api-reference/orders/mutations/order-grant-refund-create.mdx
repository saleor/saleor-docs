...
#### [<code style={{ fontWeight: 'normal' }}>orderGrantRefundCreate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the order.

#### [<code style={{ fontWeight: 'normal' }}>orderGrantRefundCreate.<b>input</b></code>](#)<Bullet />[`OrderGrantRefundCreateInput!`](../../../api-reference/orders/inputs/order-grant-refund-create-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>
