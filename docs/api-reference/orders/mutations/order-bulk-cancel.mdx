...
#### [<code style={{ fontWeight: 'normal' }}>orderBulkCancel.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of orders IDs to cancel.

### Type

#### [`OrderBulkCancel`](../../../api-reference/orders/objects/order-bulk-cancel) <Badge class="secondary" text="object"/>
