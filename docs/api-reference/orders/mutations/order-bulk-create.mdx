...
#### [<code>orders</code>](#orders)<Bullet />[<code>[OrderBulkCreateInput!]!</code>](/api-reference/orders/inputs/order-bulk-create-input.mdx) \{#orders\}

Input list of orders to create. Orders limit: 50.

#### [<code>stockUpdatePolicy</code>](#stock-update-policy)<Bullet />[<code>StockUpdatePolicyEnum</code>](/api-reference/miscellaneous/enums/stock-update-policy-enum.mdx) \{#stock-update-policy\}
