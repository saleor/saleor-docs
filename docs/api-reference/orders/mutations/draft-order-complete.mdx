...
#### [<code style={{ fontWeight: 'normal' }}>draftOrderComplete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of the order that will be completed.

### Type

#### [`DraftOrderComplete`](../../../api-reference/orders/objects/draft-order-complete) <Badge class="badge badge--secondary" text="object"/>
