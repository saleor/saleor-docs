...
#### [<code style={{ fontWeight: 'normal' }}>draftOrderComplete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the order that will be completed.

### Type

#### [`DraftOrderComplete`](../../../api-reference/orders/objects/draft-order-complete) <Badge class="secondary" text="object"/>
