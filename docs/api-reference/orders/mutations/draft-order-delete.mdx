...
#### [<code style={{ fontWeight: 'normal' }}>draftOrderDelete.<b>externalReference</b></code>](#)<Bullet />[`String`](../../../api-reference/miscellaneous/scalars/string) <Badge class="secondary" text="scalar"/>

> External ID of a product to delete.
>
> <Badge text="Added in Saleor 3.10" class="secondary margin-bottom--sm" />

#### [<code style={{ fontWeight: 'normal' }}>draftOrderDelete.<b>id</b></code>](#)<Bullet />[`ID`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="scalar"/>

> ID of a product to delete.

### Type

#### [`DraftOrderDelete`](../../../api-reference/orders/objects/draft-order-delete) <Badge class="secondary" text="object"/>
