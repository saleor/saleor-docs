...
#### [<code style={{ fontWeight: 'normal' }}>invoiceRequestDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of an invoice to request the deletion.

### Type

#### [`InvoiceRequestDelete`](../../../api-reference/orders/objects/invoice-request-delete) <Badge class="badge badge--secondary" text="object"/>
