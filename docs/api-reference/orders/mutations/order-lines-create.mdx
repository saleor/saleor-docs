...
#### [<code>input</code>](#)<Bullet />[<code>[OrderLineCreateInput!]!</code>](/api-reference/orders/inputs/order-line-create-input.mdx)

Fields required to add order lines.

### Type

#### [<code>OrderLinesCreate</code>](/api-reference/orders/objects/order-lines-create.mdx)
