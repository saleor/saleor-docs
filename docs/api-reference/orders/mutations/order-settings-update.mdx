...
#### [<code style={{ fontWeight: 'normal' }}>orderSettingsUpdate.<b>input</b></code>](#)<Bullet />[`OrderSettingsUpdateInput!`](../../../api-reference/orders/inputs/order-settings-update-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="orders"/>

> Fields required to update shop order settings.

### Type

#### [`OrderSettingsUpdate`](../../../api-reference/orders/objects/order-settings-update) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="orders"/>
