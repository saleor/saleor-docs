...
[`draftOrderLinesBulkDelete`](/api-reference/deprecated/orders/mutations/draft-order-lines-bulk-delete) <mark class="gqlmd-mdx-badge">mutation</mark>
