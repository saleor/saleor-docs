...
#### [<code>errors</code>](#)<Bullet />[<code>[OrderSettingsError!]!</code>](/api-reference/orders/objects/order-settings-error.mdx)

<Details dataOpen="Hide deprecated" dataClose="Show deprecated">

#### [<code>orderSettingsErrors</code>](#)<Bullet />[<code>[OrderSettingsError!]!</code>](/api-reference/orders/objects/order-settings-error.mdx)
