...
#### [<code style={{ fontWeight: 'normal' }}>OrderCreateFromCheckout.<b>order</b></code>](#)<Bullet />[`Order`](../../../api-reference/orders/objects/order.mdx) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="orders"/>

Placed order.

#### [<code style={{ fontWeight: 'normal' }}>OrderCreateFromCheckout.<b>errors</b></code>](#)<Bullet />[`[OrderCreateFromCheckoutError!]!`](../../../api-reference/orders/objects/order-create-from-checkout-error.mdx) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="orders"/>

### Returned By

[`orderCreateFromCheckout`](../../../api-reference/orders/mutations/order-create-from-checkout.mdx) <Badge class="badge badge--secondary" text="mutation"/>
