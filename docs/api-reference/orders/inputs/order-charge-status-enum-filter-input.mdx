...
#### [<code>eq</code>](#eq)<Bullet />[<code>OrderChargeStatusEnum</code>](/api-reference/orders/enums/order-charge-status-enum.mdx) \{#eq\}

The value equal to.

#### [<code>oneOf</code>](#one-of)<Bullet />[<code>[OrderChargeStatusEnum!]</code>](/api-reference/orders/enums/order-charge-status-enum.mdx) \{#one-of\}
