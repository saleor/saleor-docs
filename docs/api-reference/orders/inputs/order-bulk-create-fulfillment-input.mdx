...
#### [<code>trackingCode</code>](#)<Bullet />[<code>String</code>](/api-reference/miscellaneous/scalars/string.mdx)

Fulfillment's tracking code.

#### [<code>lines</code>](#)<Bullet />[<code>[OrderBulkCreateFulfillmentLineInput!]</code>](/api-reference/orders/inputs/order-bulk-create-fulfillment-line-input.mdx)
