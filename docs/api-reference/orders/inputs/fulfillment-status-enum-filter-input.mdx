...
#### [<code>eq</code>](#)<Bullet />[<code>FulfillmentStatus</code>](/api-reference/orders/enums/fulfillment-status.mdx)

The value equal to.

#### [<code>oneOf</code>](#)<Bullet />[<code>[FulfillmentStatus!]</code>](/api-reference/orders/enums/fulfillment-status.mdx)
