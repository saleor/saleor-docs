...
#### [<code>eq</code>](#eq)<Bullet />[<code>FulfillmentStatus</code>](/api-reference/orders/enums/fulfillment-status.mdx) \{#eq\}

The value equal to.

#### [<code>oneOf</code>](#one-of)<Bullet />[<code>[FulfillmentStatus!]</code>](/api-reference/orders/enums/fulfillment-status.mdx) \{#one-of\}
