...
#### [<code>id</code>](#id)<Bullet />[<code>GlobalIDFilterInput</code>](/api-reference/miscellaneous/inputs/global-idfilter-input.mdx) \{#id\}
...
#### [<code>externalReference</code>](#external-reference)<Bullet />[<code>StringFilterInput</code>](/api-reference/miscellaneous/inputs/string-filter-input.mdx) \{#external-reference\}

Filter fulfillments by warehouse external reference.

### Member Of

[`FulfillmentFilterInput`](/api-reference/orders/inputs/fulfillment-filter-input.mdx) <Badge class="badge badge--secondary badge--relation" text="input"/>
