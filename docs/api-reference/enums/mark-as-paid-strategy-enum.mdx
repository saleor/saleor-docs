...
[`OrderSettings`](../../api-reference/objects/order-settings) <Badge class="secondary" text="object"/><Bullet />[`OrderSettingsInput`](../../api-reference/inputs/order-settings-input) <Badge class="secondary" text="input"/>
