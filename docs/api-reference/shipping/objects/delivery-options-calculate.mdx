...
#### [<code>deliveries</code>](#)<Bullet />[<code>[Delivery!]!</code>](/api-reference/miscellaneous/objects/delivery.mdx)

List of the available deliveries.

#### [<code>errors</code>](#)<Bullet />[<code>[DeliveryOptionsCalculateError!]!</code>](/api-reference/shipping/objects/delivery-options-calculate-error.mdx)
