...
#### [<code>input</code>](#)<Bullet />[<code>ShippingZoneUpdateInput!</code>](/api-reference/shipping/inputs/shipping-zone-update-input.mdx)

Fields required to update a shipping zone.

### Type

#### [<code>ShippingZoneUpdate</code>](/api-reference/shipping/objects/shipping-zone-update.mdx)
