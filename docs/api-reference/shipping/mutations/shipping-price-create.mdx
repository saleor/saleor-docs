...
#### [<code>input</code>](#input)<Bullet />[<code>ShippingPriceInput!</code>](/api-reference/shipping/inputs/shipping-price-input.mdx) \{#input\}

Fields required to create a shipping price.

### Type

#### [<code>ShippingPriceCreate</code>](/api-reference/shipping/objects/shipping-price-create.mdx)
