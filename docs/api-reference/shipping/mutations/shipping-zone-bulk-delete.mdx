...
#### [<code style={{ fontWeight: 'normal' }}>shippingZoneBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of shipping zone IDs to delete.

### Type

#### [`ShippingZoneBulkDelete`](../../../api-reference/shipping/objects/shipping-zone-bulk-delete) <Badge class="secondary" text="object"/>
