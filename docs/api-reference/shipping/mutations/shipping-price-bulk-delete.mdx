...
#### [<code style={{ fontWeight: 'normal' }}>shippingPriceBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of shipping price IDs to delete.

### Type

#### [`ShippingPriceBulkDelete`](../../../api-reference/shipping/objects/shipping-price-bulk-delete) <Badge class="secondary" text="object"/>
