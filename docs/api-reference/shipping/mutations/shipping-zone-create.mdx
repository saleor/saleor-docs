...
#### [<code>input</code>](#input)<Bullet />[<code>ShippingZoneCreateInput!</code>](/api-reference/shipping/inputs/shipping-zone-create-input.mdx) \{#input\}

Fields required to create a shipping zone.

### Type

#### [<code>ShippingZoneCreate</code>](/api-reference/shipping/objects/shipping-zone-create.mdx)
