...
#### [<code style={{ fontWeight: 'normal' }}>webhookDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/> <Badge class="badge badge--secondary" text="miscellaneous"/>

> ID of a webhook to delete.

### Type

#### [`WebhookDelete`](../../../api-reference/webhooks/objects/webhook-delete) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="webhooks"/>
