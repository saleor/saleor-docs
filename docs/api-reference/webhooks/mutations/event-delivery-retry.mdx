...
#### [<code style={{ fontWeight: 'normal' }}>eventDeliveryRetry.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of the event delivery to retry.

### Type

#### [`EventDeliveryRetry`](../../../api-reference/webhooks/objects/event-delivery-retry) <Badge class="secondary" text="object"/>
