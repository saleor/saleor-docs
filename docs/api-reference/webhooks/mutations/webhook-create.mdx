...
#### [<code>input</code>](#input)<Bullet />[<code>WebhookCreateInput!</code>](/api-reference/webhooks/inputs/webhook-create-input.mdx) \{#input\}

Fields required to create a webhook.

### Type

#### [<code>WebhookCreate</code>](/api-reference/webhooks/objects/webhook-create.mdx)
