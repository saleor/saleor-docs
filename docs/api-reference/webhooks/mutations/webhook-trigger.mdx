...
#### [<code style={{ fontWeight: 'normal' }}>webhookTrigger.<b>objectId</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> The ID of an object to serialize.

#### [<code style={{ fontWeight: 'normal' }}>webhookTrigger.<b>webhookId</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
