...
#### [<code style={{ fontWeight: 'normal' }}>WebhookDryRun.<b>payload</b></code>](#)<Bullet />[`JSONString`](../../../api-reference/miscellaneous/scalars/jsonstring) <Badge class="secondary" text="scalar"/>

> JSON payload, that would be sent out to webhook's target URL.

#### [<code style={{ fontWeight: 'normal' }}>WebhookDryRun.<b>errors</b></code>](#)<Bullet />[`[WebhookDryRunError!]!`](../../../api-reference/webhooks/objects/webhook-dry-run-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>
