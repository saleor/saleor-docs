...
#### [<code style={{ fontWeight: 'normal' }}>WebhookTrigger.<b>delivery</b></code>](#)<Bullet />[`EventDelivery`](../../../api-reference/miscellaneous/objects/event-delivery) <Badge class="secondary" text="object"/> <Badge class="secondary" text="miscellaneous"/>

>

#### [<code style={{ fontWeight: 'normal' }}>WebhookTrigger.<b>errors</b></code>](#)<Bullet />[`[WebhookTriggerError!]!`](../../../api-reference/webhooks/objects/webhook-trigger-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/> <Badge class="secondary" text="webhooks"/>
