...
#### [<code style={{ fontWeight: 'normal' }}>WebhookTrigger.<b>delivery</b></code>](#)<Bullet />[`EventDelivery`](../../../api-reference/miscellaneous/objects/event-delivery) <Badge class="badge badge--secondary" text="object"/>

>

#### [<code style={{ fontWeight: 'normal' }}>WebhookTrigger.<b>errors</b></code>](#)<Bullet />[`[WebhookTriggerError!]!`](../../../api-reference/webhooks/objects/webhook-trigger-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/>
