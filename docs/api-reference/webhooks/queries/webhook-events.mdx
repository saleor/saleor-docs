...
<Badge
  class="warning"
  text="DEPRECATED: This field will be removed in Saleor 4.0. Use `WebhookEventTypeAsyncEnum` and `WebhookEventTypeSyncEnum` to get available event types."
/>
...
#### [`WebhookEvent`](../../../api-reference/webhooks/objects/webhook-event) <Badge class="secondary" text="object"/>
