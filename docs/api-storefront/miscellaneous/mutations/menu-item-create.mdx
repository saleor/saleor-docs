...
#### [<code style={{ fontWeight: 'normal' }}>menuItemCreate.<b>input</b></code>](#)<Bullet />[`MenuItemCreateInput!`](../../../storefront/miscellaneous/inputs/menu-item-create-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to update a menu item. Only one of `url`, `category`, `page`, `collection` is allowed per item.

### Type

#### [`MenuItemCreate`](../../../storefront/miscellaneous/objects/menu-item-create) <Badge class="secondary" text="object"/>
