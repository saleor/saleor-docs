...
#### [<code style={{ fontWeight: 'normal' }}>ExternalNotificationTrigger.<b>errors</b></code>](#)<Bullet />[`[ExternalNotificationError!]!`](../../../storefront/miscellaneous/objects/external-notification-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>
