...
#### [<code style={{ fontWeight: 'normal' }}>\_entities.<b>representations</b></code>](#)<Bullet />[`[_Any]`](../../../api-storefront/miscellaneous/scalars/any) <Badge class="badge badge--secondary" text="list"/> <Badge class="badge badge--secondary" text="scalar"/>
