...
#### [<code style={{ fontWeight: 'normal' }}>OrderSettingsUpdateInput.<b>automaticallyConfirmAllNewOrders</b></code>](#)<Bullet />[`Boolean`](../../../api-storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>OrderSettingsUpdateInput.<b>automaticallyFulfillNonShippableGiftCard</b></code>](#)<Bullet />[`Boolean`](../../../api-storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>
