...
#### [<code style={{ fontWeight: 'normal' }}>OrderUpdateShippingInput.<b>shippingMethod</b></code>](#)<Bullet />[`ID`](../../../api-storefront/miscellaneous/scalars/id) <Badge class="secondary" text="scalar"/>
