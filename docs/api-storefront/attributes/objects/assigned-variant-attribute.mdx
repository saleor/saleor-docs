...
#### [<code style={{ fontWeight: 'normal' }}>AssignedVariantAttribute.<b>attribute</b></code>](#)<Bullet />[`Attribute!`](../../../api-storefront/attributes/objects/attribute) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>

> Attribute assigned to variant.

#### [<code style={{ fontWeight: 'normal' }}>AssignedVariantAttribute.<b>variantSelection</b></code>](#)<Bullet />[`Boolean!`](../../../api-storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
...
[`ProductType`](../../../api-storefront/products/objects/product-type) <Badge class="secondary" text="object"/>
