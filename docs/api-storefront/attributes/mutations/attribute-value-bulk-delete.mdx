...
#### [<code style={{ fontWeight: 'normal' }}>attributeValueBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../storefront/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of attribute value IDs to delete.

### Type

#### [`AttributeValueBulkDelete`](../../../storefront/attributes/objects/attribute-value-bulk-delete) <Badge class="secondary" text="object"/>
