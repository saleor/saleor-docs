...
#### [<code style={{ fontWeight: 'normal' }}>attributeBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../storefront/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> List of attribute IDs to delete.

### Type

#### [`AttributeBulkDelete`](../../../storefront/attributes/objects/attribute-bulk-delete) <Badge class="secondary" text="object"/>
