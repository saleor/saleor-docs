...
#### [<code style={{ fontWeight: 'normal' }}>SendConfirmationEmail.<b>errors</b></code>](#)<Bullet />[`[SendConfirmationEmailError!]!`](../../../api-storefront/users/objects/send-confirmation-email-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>

>

### Returned By

[`sendConfirmationEmail`](../../../api-storefront/users/mutations/send-confirmation-email) <Badge class="badge badge--secondary" text="mutation"/>
