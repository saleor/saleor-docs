...
#### [<code style={{ fontWeight: 'normal' }}>accountUpdate.<b>input</b></code>](#)<Bullet />[`AccountInput!`](../../../api-storefront/users/inputs/account-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/> <Badge class="badge badge--secondary" text="users"/>

> Fields required to update the account of the logged-in user.

### Type

#### [`AccountUpdate`](../../../api-storefront/users/objects/account-update) <Badge class="badge badge--secondary" text="object"/> <Badge class="badge badge--secondary" text="users"/>
