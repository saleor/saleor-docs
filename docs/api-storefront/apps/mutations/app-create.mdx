...
#### [<code style={{ fontWeight: 'normal' }}>appCreate.<b>input</b></code>](#)<Bullet />[`AppInput!`](../../../storefront/apps/inputs/app-input) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Fields required to create a new app.

### Type

#### [`AppCreate`](../../../storefront/apps/objects/app-create) <Badge class="secondary" text="object"/>
