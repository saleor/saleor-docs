...
#### [<code style={{ fontWeight: 'normal' }}>app.<b>id</b></code>](#)<Bullet />[`ID`](../../../storefront/miscellaneous/scalars/id) <Badge class="secondary" text="scalar"/>

> ID of the app.

### Type

#### [`App`](../../../storefront/apps/objects/app) <Badge class="secondary" text="object"/>
