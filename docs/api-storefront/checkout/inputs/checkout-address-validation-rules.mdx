...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>checkRequiredFields</b></code>](#)<Bullet />[`Boolean`](../../../storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>checkFieldsFormat</b></code>](#)<Bullet />[`Boolean`](../../../storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>CheckoutAddressValidationRules.<b>enableFieldsNormalization</b></code>](#)<Bullet />[`Boolean`](../../../storefront/miscellaneous/scalars/boolean) <Badge class="secondary" text="scalar"/>

> Determines if Saleor should apply normalization on address fields. Example: converting city field to uppercase letters.

### Member of

[`checkoutBillingAddressUpdate`](../../../storefront/checkout/mutations/checkout-billing-address-update) <Badge class="secondary" text="mutation"/><Bullet />[`checkoutShippingAddressUpdate`](../../../storefront/checkout/mutations/checkout-shipping-address-update) <Badge class="secondary" text="mutation"/><Bullet />[`CheckoutValidationRules`](../../../storefront/checkout/inputs/checkout-validation-rules) <Badge class="secondary" text="input"/>
