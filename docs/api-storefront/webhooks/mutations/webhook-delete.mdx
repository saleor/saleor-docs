...
#### [<code style={{ fontWeight: 'normal' }}>webhookDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../storefront/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> ID of a webhook to delete.

### Type

#### [`WebhookDelete`](../../../storefront/webhooks/objects/webhook-delete) <Badge class="secondary" text="object"/>
