...
#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>taxableObject</b></code>](#)<Bullet />[`TaxSourceObject`](../../../storefront/miscellaneous/unions/tax-source-object) <Badge class="secondary" text="union"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TaxExemptionManage.<b>errors</b></code>](#)<Bullet />[`[TaxExemptionManageError!]!`](../../../storefront/taxes/objects/tax-exemption-manage-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>

>

### Returned by

[`taxExemptionManage`](../../../storefront/taxes/mutations/tax-exemption-manage) <Badge class="secondary" text="mutation"/>
