...
#### [<code style={{ fontWeight: 'normal' }}>StockSettings.<b>allocationStrategy</b></code>](#)<Bullet />[`AllocationStrategyEnum!`](../../../api-storefront/products/enums/allocation-strategy-enum) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="enum"/>
