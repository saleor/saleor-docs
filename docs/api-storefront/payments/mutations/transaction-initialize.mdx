...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>action</b></code>](#)<Bullet />[`TransactionFlowStrategyEnum`](../../../api-storefront/payments/enums/transaction-flow-strategy-enum) <Badge class="secondary" text="enum"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>amount</b></code>](#)<Bullet />[`PositiveDecimal`](../../../api-storefront/miscellaneous/scalars/positive-decimal) <Badge class="secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-storefront/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>

> The ID of the checkout or order.

#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>paymentGateway</b></code>](#)<Bullet />[`PaymentGatewayToInitialize!`](../../../api-storefront/payments/inputs/payment-gateway-to-initialize) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="input"/>

> Payment gateway used to initialize the transaction.

### Type

#### [`TransactionInitialize`](../../../api-storefront/payments/objects/transaction-initialize) <Badge class="secondary" text="object"/>
