...
#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>amount</b></code>](#)<Bullet />[`PositiveDecimal`](../../../api-storefront/miscellaneous/scalars/positive-decimal) <Badge class="badge badge--secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-storefront/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> The ID of the checkout or order.

#### [<code style={{ fontWeight: 'normal' }}>paymentGatewayInitialize.<b>paymentGateways</b></code>](#)<Bullet />[`[PaymentGatewayToInitialize!]`](../../../api-storefront/payments/inputs/payment-gateway-to-initialize) <Badge class="badge badge--secondary" text="list"/> <Badge class="badge badge--secondary" text="input"/>
