...
#### [<code style={{ fontWeight: 'normal' }}>PaymentGatewayInitialize.<b>gatewayConfigs</b></code>](#)<Bullet />[`[PaymentGatewayConfig!]`](../../../api-storefront/payments/objects/payment-gateway-config) <Badge class="secondary" text="list"/> <Badge class="secondary" text="object"/>

>

#### [<code style={{ fontWeight: 'normal' }}>PaymentGatewayInitialize.<b>errors</b></code>](#)<Bullet />[`[PaymentGatewayInitializeError!]!`](../../../api-storefront/payments/objects/payment-gateway-initialize-error) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="object"/>

>

### Returned by

[`paymentGatewayInitialize`](../../../api-storefront/payments/mutations/payment-gateway-initialize) <Badge class="secondary" text="mutation"/>
