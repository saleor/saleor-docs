...
#### [<code style={{ fontWeight: 'normal' }}>ChannelDeleteInput.<b>channelId</b></code>](#)<Bullet />[`ID!`](../../../api-storefront/miscellaneous/scalars/id) <Badge class="secondary" text="non-null"/> <Badge class="secondary" text="scalar"/>
