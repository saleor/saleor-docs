...
[`OrderSettings`](../../../storefront/miscellaneous/objects/order-settings) <Badge class="secondary" text="object"/><Bullet />[`OrderSettingsInput`](../../../storefront/orders/inputs/order-settings-input) <Badge class="secondary" text="input"/>
