...
![Warehouses management screen](/assets/dashboard-config/warehouses-list.png)

Select _Create&nbsp;Warehouse_ and fill in the name and address information.

![Warehouse creation](/assets/dashboard-config/warehouses-new.png)

## Adding a warehouse to a shipping zone

To assign a warehouse to a shipping zone, visit the shipping zone's details page.

![Shipping zone warehouse assignment](/assets/dashboard-config/warehouses-assign.png)
