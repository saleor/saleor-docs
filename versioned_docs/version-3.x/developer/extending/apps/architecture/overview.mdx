...
:::info
If you're building a single service dedicated only to your shop, check [Webhooks](developer/extending/webhooks/overview.mdx) section of [Extending dashboard](developer/extending/overview.mdx#webhooksa) as it may handle all your needs.
:::
