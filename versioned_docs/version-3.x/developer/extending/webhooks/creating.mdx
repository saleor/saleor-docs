...
If you change the webhook subscription, you may need to update the webhook in Saleor API. You can read more about it in the [How to update app webhooks](developer/extending/apps/updating-app-webhooks.mdx) guide.
