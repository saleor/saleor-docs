...
You can find more details about the transaction flow in the [_Payments_ documentation](../../../payments).
...
[transactionEventReport](../../../payments#reporting-actions-for-transactions)
mutation.
