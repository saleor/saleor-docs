...
[NOTIFY_USER](../../../api-reference/webhooks/enums/webhook-event-type-async-enum#webhookeventtypeasyncenumnotify_user) is raised to trigger a new notification to the user.
