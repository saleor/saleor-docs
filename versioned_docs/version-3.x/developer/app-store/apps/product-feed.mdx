...
_Product Feed_ app allows generating an XML file file with products and their details. The file can be used as a feed source for Google Merchant Center.
