...
:::caution DEPRECATED
Alternatively you can add `avataxCustomerCode` to `User` metadata. If the user is logged in, the Avatax app will use the user's id as the customer code. If the user is not logged in a dummy customer code will be used.
:::
