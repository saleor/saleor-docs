...
If you don't find an answer below or have a different question, please [contact us on GitHub Discussions](https://github.com/saleor/saleor/discussions).
...
```note
If you get this error, you are probably running Saleor outside docker containers.
...
You can find more information [here](developer/extending/plugins/overview.mdx).

## How can I create and integrate a custom tool to Saleor?

Firstly, please figure out what Saleor needs to know about the custom tool you would like to use. There is a possibility of direct communication between the storefront and the tool. It is the case with most content management systems.
...
- [Saleor React Storefront](https://github.com/saleor/react-storefront)
