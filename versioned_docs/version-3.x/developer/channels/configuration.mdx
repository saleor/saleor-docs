...
- **Allocation strategy**: Determines the rules on which warehouse is picked for stock reservation and allocation, [learn more](developer/stock-allocation#allocation-strategies).
- **Warehouse**: Assign warehouses that would be used for fulfilment.
