...
4. Creating the product:
   1. Create product with a type _T-shirt_.
   2. Name the product _T-shirt with a print_.
   3. Assign the product to category _T-shirts_.
   4. Type _Cotton_ in the _Material_ field.
   5. Save product.
   6. Add variants S, M, L, XL, XXL. Each variant can be mapped to a "Size" attribute.
   7. To edit length attribute open the variant editor and fill in the length description.

### Assigning stock and price
