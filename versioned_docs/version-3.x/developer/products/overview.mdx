...
**Size:** of the shirt is a product option that can be selected by the customer; it comes with predefined sizes, so it will be of type _Dropdown_ and _Variant selection attribute_.
