...
4. In the product variant settings, check if the `Warehouses` of the shipping zone have stock. Only warehouses enabled in the shipping zone are considered for stock availability.
