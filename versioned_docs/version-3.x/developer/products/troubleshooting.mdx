...
Checkout is always channel-specific, products must be available in the respective channel and be shippable to default country of the channel (check settings of the channel). Follow steps [Product can't be added to an order](#product-cant-be-added-to-an-order) .
