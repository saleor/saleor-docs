...
- **Multiple geographical markets:**. Each market has different prices, taxes, shipping options, stock availability, backoffice integrations, etc.

- **B2B and B2C:** Channels can be mapped by customer types to grant exclusivity of prices and services.
...
- **Multi-brand:** businesses that wish to share customer data, loyalty programs, and products but want to have separate order data.

- **A/B testing:** testing different pricing strategies for product and fulfilment.
