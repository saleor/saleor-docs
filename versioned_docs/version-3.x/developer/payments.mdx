...
The key should be also stored in a form of persistant storage. This way it can be re-used even if the user leaves the page / app. In Web this can be done with `localStorage`:
