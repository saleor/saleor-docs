...
To learn more about Saleor APIs interactively, you can inspect GraphQL operations using the browser's native network inspector or [GraphQL inspector](https://chromewebstore.google.com/detail/graphql-network-inspector/) while using the dashboard.

- Learn more about [Devtools](api-usage/developer-tools.mdx)
