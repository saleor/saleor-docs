...
- Create a checkout with channel and non-shippable lines. Since the shipping address is empty, taxes are calculated based on the store address (Country US, state LA)
