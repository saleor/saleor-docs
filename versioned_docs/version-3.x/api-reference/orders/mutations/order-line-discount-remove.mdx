...
#### [<code style={{ fontWeight: 'normal' }}>orderLineDiscountRemove.<b>orderLineId</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a order line to remove its discount

### Type

#### [`OrderLineDiscountRemove`](../../../api-reference/orders/objects/order-line-discount-remove) <Badge class="badge badge--secondary" text="object"/>
