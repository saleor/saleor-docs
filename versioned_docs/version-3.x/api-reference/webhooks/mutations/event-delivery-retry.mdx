...
#### [<code style={{ fontWeight: 'normal' }}>eventDeliveryRetry.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of the event delivery to retry.

### Type

#### [`EventDeliveryRetry`](../../../api-reference/webhooks/objects/event-delivery-retry) <Badge class="badge badge--secondary" text="object"/>
