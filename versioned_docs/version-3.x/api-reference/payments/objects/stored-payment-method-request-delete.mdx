...
#### [<code style={{ fontWeight: 'normal' }}>StoredPaymentMethodRequestDelete.<b>result</b></code>](#)<Bullet />[`StoredPaymentMethodRequestDeleteResult!`](../../../api-reference/payments/enums/stored-payment-method-request-delete-result) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="enum"/>
