...
#### [<code style={{ fontWeight: 'normal' }}>PaymentGatewayInitialize.<b>gatewayConfigs</b></code>](#)<Bullet />[`[PaymentGatewayConfig!]`](../../../api-reference/payments/objects/payment-gateway-config) <Badge class="badge badge--secondary" text="list"/> <Badge class="badge badge--secondary" text="object"/>

> List of payment gateway configurations.

#### [<code style={{ fontWeight: 'normal' }}>PaymentGatewayInitialize.<b>errors</b></code>](#)<Bullet />[`[PaymentGatewayInitializeError!]!`](../../../api-reference/payments/objects/payment-gateway-initialize-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/>
