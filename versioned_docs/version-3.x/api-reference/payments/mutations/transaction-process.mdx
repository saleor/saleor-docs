...
#### [<code style={{ fontWeight: 'normal' }}>transactionProcess.<b>customerIpAddress</b></code>](#)<Bullet />[`String`](../../../api-reference/miscellaneous/scalars/string) <Badge class="badge badge--secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionProcess.<b>id</b></code>](#)<Bullet />[`ID`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="scalar"/>

> The ID of the transaction to process. Required if token is not provided.

#### [<code style={{ fontWeight: 'normal' }}>transactionProcess.<b>token</b></code>](#)<Bullet />[`UUID`](../../../api-reference/miscellaneous/scalars/uuid) <Badge class="badge badge--secondary" text="scalar"/>
