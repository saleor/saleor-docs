...
#### [<code style={{ fontWeight: 'normal' }}>voucherCreate.<b>input</b></code>](#)<Bullet />[`VoucherInput!`](../../../api-reference/discounts/inputs/voucher-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to create a voucher.

### Type

#### [`VoucherCreate`](../../../api-reference/discounts/objects/voucher-create) <Badge class="badge badge--secondary" text="object"/>
