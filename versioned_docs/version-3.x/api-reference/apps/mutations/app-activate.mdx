...
#### [<code style={{ fontWeight: 'normal' }}>appActivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of app to activate.

### Type

#### [`AppActivate`](../../../api-reference/apps/objects/app-activate) <Badge class="badge badge--secondary" text="object"/>
