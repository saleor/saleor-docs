...
#### [<code style={{ fontWeight: 'normal' }}>accountUpdate.<b>input</b></code>](#)<Bullet />[`AccountInput!`](../../../api-reference/users/inputs/account-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to update the account of the logged-in user.

### Type

#### [`AccountUpdate`](../../../api-reference/users/objects/account-update) <Badge class="badge badge--secondary" text="object"/>
