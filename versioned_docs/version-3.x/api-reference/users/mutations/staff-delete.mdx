...
#### [<code style={{ fontWeight: 'normal' }}>staffDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a staff user to delete.

### Type

#### [`StaffDelete`](../../../api-reference/users/objects/staff-delete) <Badge class="badge badge--secondary" text="object"/>
