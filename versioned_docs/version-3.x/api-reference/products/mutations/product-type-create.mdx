...
#### [<code style={{ fontWeight: 'normal' }}>productTypeCreate.<b>input</b></code>](#)<Bullet />[`ProductTypeInput!`](../../../api-reference/products/inputs/product-type-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to create a product type.

### Type

#### [`ProductTypeCreate`](../../../api-reference/products/objects/product-type-create) <Badge class="badge badge--secondary" text="object"/>
