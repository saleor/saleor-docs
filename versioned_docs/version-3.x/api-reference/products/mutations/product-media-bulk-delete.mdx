...
#### [<code style={{ fontWeight: 'normal' }}>productMediaBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of product media IDs to delete.

### Type

#### [`ProductMediaBulkDelete`](../../../api-reference/products/objects/product-media-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
