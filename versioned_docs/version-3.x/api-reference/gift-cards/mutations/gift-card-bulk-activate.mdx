...
#### [<code style={{ fontWeight: 'normal' }}>giftCardBulkActivate.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of gift card IDs to activate.

### Type

#### [`GiftCardBulkActivate`](../../../api-reference/gift-cards/objects/gift-card-bulk-activate) <Badge class="badge badge--secondary" text="object"/>
