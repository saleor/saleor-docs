...
#### [<code style={{ fontWeight: 'normal' }}>giftCardActivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a gift card to activate.

### Type

#### [`GiftCardActivate`](../../../api-reference/gift-cards/objects/gift-card-activate) <Badge class="badge badge--secondary" text="object"/>
