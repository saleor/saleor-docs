...
#### [<code style={{ fontWeight: 'normal' }}>giftCardBulkDelete.<b>ids</b></code>](#)<Bullet />[`[ID!]!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> List of gift card IDs to delete.

### Type

#### [`GiftCardBulkDelete`](../../../api-reference/gift-cards/objects/gift-card-bulk-delete) <Badge class="badge badge--secondary" text="object"/>
