...
#### [<code style={{ fontWeight: 'normal' }}>giftCardDeactivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a gift card to deactivate.

### Type

#### [`GiftCardDeactivate`](../../../api-reference/gift-cards/objects/gift-card-deactivate) <Badge class="badge badge--secondary" text="object"/>
