...
#### [<code style={{ fontWeight: 'normal' }}>shippingZoneDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a shipping zone to delete.

### Type

#### [`ShippingZoneDelete`](../../../api-reference/shipping/objects/shipping-zone-delete) <Badge class="badge badge--secondary" text="object"/>
