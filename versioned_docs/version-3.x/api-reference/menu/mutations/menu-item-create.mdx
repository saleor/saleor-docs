...
#### [<code style={{ fontWeight: 'normal' }}>menuItemCreate.<b>input</b></code>](#)<Bullet />[`MenuItemCreateInput!`](../../../api-reference/miscellaneous/inputs/menu-item-create-input) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Fields required to update a menu item. Only one of `url`, `category`, `page`, `collection` is allowed per item.

### Type

#### [`MenuItemCreate`](../../../api-reference/menu/objects/menu-item-create) <Badge class="badge badge--secondary" text="object"/>
