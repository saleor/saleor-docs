...
#### [<code style={{ fontWeight: 'normal' }}>menuDelete.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of a menu to delete.

### Type

#### [`MenuDelete`](../../../api-reference/menu/objects/menu-delete) <Badge class="badge badge--secondary" text="object"/>
