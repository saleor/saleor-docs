...
#### [<code style={{ fontWeight: 'normal' }}>TaxClassDelete.<b>errors</b></code>](#)<Bullet />[`[TaxClassDeleteError!]!`](../../../api-reference/taxes/objects/tax-class-delete-error) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="object"/>

>

#### [<code style={{ fontWeight: 'normal' }}>TaxClassDelete.<b>taxClass</b></code>](#)<Bullet />[`TaxClass`](../../../api-reference/taxes/objects/tax-class) <Badge class="badge badge--secondary" text="object"/>
