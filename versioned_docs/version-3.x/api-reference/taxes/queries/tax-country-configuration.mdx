...
#### [<code style={{ fontWeight: 'normal' }}>taxCountryConfiguration.<b>countryCode</b></code>](#)<Bullet />[`CountryCode!`](../../../api-reference/miscellaneous/enums/country-code) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="enum"/>

> Country for which to return tax class rates.

### Type

#### [`TaxCountryConfiguration`](../../../api-reference/taxes/objects/tax-country-configuration) <Badge class="badge badge--secondary" text="object"/>
