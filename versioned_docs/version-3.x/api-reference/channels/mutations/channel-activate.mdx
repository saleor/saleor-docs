...
#### [<code style={{ fontWeight: 'normal' }}>channelActivate.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-reference/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> ID of the channel to activate.

### Type

#### [`ChannelActivate`](../../../api-reference/channels/objects/channel-activate) <Badge class="badge badge--secondary" text="object"/>
