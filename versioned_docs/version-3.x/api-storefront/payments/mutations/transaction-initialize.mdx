...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>action</b></code>](#)<Bullet />[`TransactionFlowStrategyEnum`](../../../api-storefront/payments/enums/transaction-flow-strategy-enum) <Badge class="badge badge--secondary" text="enum"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>amount</b></code>](#)<Bullet />[`PositiveDecimal`](../../../api-storefront/miscellaneous/scalars/positive-decimal) <Badge class="badge badge--secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>customerIpAddress</b></code>](#)<Bullet />[`String`](../../../api-storefront/miscellaneous/scalars/string) <Badge class="badge badge--secondary" text="scalar"/>
...
#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>id</b></code>](#)<Bullet />[`ID!`](../../../api-storefront/miscellaneous/scalars/id) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="scalar"/>

> The ID of the checkout or order.

#### [<code style={{ fontWeight: 'normal' }}>transactionInitialize.<b>paymentGateway</b></code>](#)<Bullet />[`PaymentGatewayToInitialize!`](../../../api-storefront/payments/inputs/payment-gateway-to-initialize) <Badge class="badge badge--secondary" text="non-null"/> <Badge class="badge badge--secondary" text="input"/>

> Payment gateway used to initialize the transaction.

### Type

#### [`TransactionInitialize`](../../../api-storefront/payments/objects/transaction-initialize) <Badge class="badge badge--secondary" text="object"/>
