...
#### [<code style={{ fontWeight: 'normal' }}>CountryFilterInput.<b>attachedToShippingZones</b></code>](#)<Bullet />[`Boolean`](../../../api-storefront/miscellaneous/scalars/boolean) <Badge class="badge badge--secondary" text="scalar"/>
